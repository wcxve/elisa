...
class BandComponent(SpectralComponent):
    ...
    def __init__(
        self, alpha, beta, Ec, norm, name=None, integral_method="simpson"
    ):
        kwargs = {
...
class BandEpComponent(SpectralComponent):
    ...
    def __init__(
        self, alpha, beta, Ep, norm, name=None, integral_method="simpson"
    ):
        kwargs = {
            k: v for k, v in locals().items() if k not in ("self", "__class__")
        }
...
class CutoffPowerlawComponent(SpectralComponent):
    ...
    def __init__(
        self, PhoIndex, Ec, norm, name=None, integral_method="simpson"
    ):
        kwargs = {
            k: v for k, v in locals().items() if k not in ("self", "__class__")
        }
...
class Band(SpectralModel):
    def __init__(
        ...
        super().__init__(
            [BandComponent(alpha, beta, Ec, norm, name, integral_method)]
        )
...
class BandEp(SpectralModel):
    def __init__(
        ...
        super().__init__(
            [BandEpComponent(alpha, beta, Ep, norm, name, integral_method)]
        )


class BlackBody(SpectralModel):
    def __init__(
        self, kT=None, norm=None, name=None, integral_method="simpson"
    ):
...
class BlackBodyRad(SpectralModel):
    def __init__(
        ...
        super().__init__(
            [BlackBodyRadComponent(kT, norm, name, integral_method)]
        )
...
class Comptonized(SpectralModel):
    def __init__(
        ...
        super().__init__(
            [ComptonizedComponent(alpha, Ep, norm, name, integral_method)]
        )
...
class CutoffPowerlaw(SpectralModel):
    def __init__(
        ...
        super().__init__(
            [
                CutoffPowerlawComponent(
                    PhoIndex, Ec, norm, name, integral_method
                )
            ]
        )
