...
class TBfeoComponent(SpectralComponent):
    _comp_name = "TBfeo"
    _config = {
        "nH": (1.0, 0.0, 1000000.0, False, False),
        "O": (1.0, -1e38, 1e38, True, False),
        "Fe": (1.0, -1e38, 1e38, True, False),
        "redshift": (0.0, -1.0, 10.0, True, False),
    }
    _op_class = TBfeoOp
...
class TBfeo(SpectralModel):
    def __init__(
        ...
        super().__init__(
            [TBfeoComponent(nH, O, Fe, redshift, name, grad_method, eps)]
        )
...
class TBgas(SpectralModel):
    def __init__(
        self, nH=None, redshift=None, name=None, grad_method="f", eps=1e-7
    ):
        super().__init__(
            [TBgasComponent(nH, redshift, name, grad_method, eps)]
        )
...
class TBgrainComponent(SpectralComponent):
    ...
    _config = {
        "nH": (1.0, 0.0, 1000000.0, False, False),
        "h2": (0.2, 0.0, 1.0, True, False),
        "rho": (1.0, 0.0, 5.0, True, False),
        "amin": (0.025, 0.0, 0.25, True, False),
        "amax": (0.25, 0.0, 1.0, True, False),
        "PL": (3.5, 0.0, 5.0, True, False),
    }
    _op_class = TBgrainOp
...
class TBgrain(SpectralModel):
    def __init__(
        ...
        super().__init__(
            [
                TBgrainComponent(
                    nH, h2, rho, amin, amax, PL, name, grad_method, eps
                )
            ]
        )
...
class TBpcf(SpectralModel):
    def __init__(
        ...
        super().__init__(
            [TBpcfComponent(nH, pcf, redshift, name, grad_method, eps)]
        )
...
class TBrelComponent(SpectralComponent):
    _comp_name = "TBrel"
    _config = {
        "nH": (0.0, -1000000.0, 1000000.0, False, False),
        "He": (1.0, 0.0, 1e38, True, False),
        "C": (1.0, 0.0, 1e38, True, False),
        "N": (1.0, 0.0, 1e38, True, False),
        "O": (1.0, 0.0, 1e38, True, False),
        "Ne": (1.0, 0.0, 1e38, True, False),
        "Na": (1.0, 0.0, 1e38, True, False),
        "Mg": (1.0, 0.0, 1e38, True, False),
        "Al": (1.0, 0.0, 1e38, True, False),
        "Si": (1.0, 0.0, 1e38, True, False),
        "S": (1.0, 0.0, 1e38, True, False),
        "Cl": (1.0, 0.0, 1e38, True, False),
        "Ar": (1.0, 0.0, 1e38, True, False),
        "Ca": (1.0, 0.0, 1e38, True, False),
        "Cr": (1.0, 0.0, 1e38, True, False),
        "Fe": (1.0, 0.0, 1e38, True, False),
        "Co": (1.0, 0.0, 1e38, True, False),
        "Ni": (1.0, 0.0, 1e38, True, False),
        "H2": (0.2, 0.0, 1.0, True, False),
        "rho": (1.0, 0.0, 5.0, True, False),
        "amin": (0.025, 0.0, 0.25, True, False),
        "amax": (0.25, 0.0, 1.0, True, False),
        "PL": (3.5, 0.0, 5.0, True, False),
        "H_dep": (1.0, 0.0, 1.0, True, False),
        "He_dep": (1.0, 0.0, 1.0, True, False),
        "C_dep": (0.5, 0.0, 1.0, True, False),
        "N_dep": (1.0, 0.0, 1.0, True, False),
        "O_dep": (0.6, 0.0, 1.0, True, False),
        "Ne_dep": (1.0, 0.0, 1.0, True, False),
        "Na_dep": (0.25, 0.0, 1.0, True, False),
        "Mg_dep": (0.2, 0.0, 1.0, True, False),
        "Al_dep": (0.02, 0.0, 1.0, True, False),
        "Si_dep": (0.1, 0.0, 1.0, True, False),
        "S_dep": (0.6, 0.0, 1.0, True, False),
        "Cl_dep": (0.5, 0.0, 1.0, True, False),
        "Ar_dep": (1.0, 0.0, 1.0, True, False),
        "Ca_dep": (0.003, 0.0, 1.0, True, False),
        "Cr_dep": (0.03, 0.0, 1.0, True, False),
        "Fe_dep": (0.3, 0.0, 1.0, True, False),
        "Co_dep": (0.05, 0.0, 1.0, True, False),
        "Ni_dep": (0.04, 0.0, 1.0, True, False),
        "redshift": (0.0, -1.0, 10.0, True, False),
    }
    _op_class = TBrelOp
...
class TBvarabsComponent(SpectralComponent):
    ...
    _config = {
        "nH": (1.0, 0.0, 1000000.0, False, False),
        "He": (1.0, 0.0, 1.0, True, False),
        "C": (1.0, 0.0, 1.0, True, False),
        "N": (1.0, 0.0, 1.0, True, False),
        "O": (1.0, 0.0, 1.0, True, False),
        "Ne": (1.0, 0.0, 1.0, True, False),
        "Na": (1.0, 0.0, 1.0, True, False),
        "Mg": (1.0, 0.0, 1.0, True, False),
        "Al": (1.0, 0.0, 1.0, True, False),
        "Si": (1.0, 0.0, 1.0, True, False),
        "S": (1.0, 0.0, 1.0, True, False),
        "Cl": (1.0, 0.0, 1.0, True, False),
        "Ar": (1.0, 0.0, 1.0, True, False),
        "Ca": (1.0, 0.0, 1.0, True, False),
        "Cr": (1.0, 0.0, 1.0, True, False),
        "Fe": (1.0, 0.0, 1.0, True, False),
        "Co": (1.0, 0.0, 1.0, True, False),
        "Ni": (1.0, 0.0, 1.0, True, False),
        "H2": (0.2, 0.0, 1.0, True, False),
        "rho": (1.0, 0.0, 5.0, True, False),
        "amin": (0.025, 0.0, 0.25, True, False),
        "amax": (0.25, 0.0, 1.0, True, False),
        ...
        "H_dep": (1.0, 0.0, 1.0, True, False),
        "He_dep": (1.0, 0.0, 1.0, True, False),
        "C_dep": (1.0, 0.0, 1.0, True, False),
        "N_dep": (1.0, 0.0, 1.0, True, False),
        "O_dep": (1.0, 0.0, 1.0, True, False),
        "Ne_dep": (1.0, 0.0, 1.0, True, False),
        "Na_dep": (1.0, 0.0, 1.0, True, False),
        "Mg_dep": (1.0, 0.0, 1.0, True, False),
        "Al_dep": (1.0, 0.0, 1.0, True, False),
        "Si_dep": (1.0, 0.0, 1.0, True, False),
        "S_dep": (1.0, 0.0, 1.0, True, False),
        "Cl_dep": (1.0, 0.0, 1.0, True, False),
        "Ar_dep": (1.0, 0.0, 1.0, True, False),
        "Ca_dep": (1.0, 0.0, 1.0, True, False),
        "Cr_dep": (1.0, 0.0, 1.0, True, False),
        "Fe_dep": (1.0, 0.0, 1.0, True, False),
        "Co_dep": (1.0, 0.0, 1.0, True, False),
        "Ni_dep": (1.0, 0.0, 1.0, True, False),
        "Redshift": (0.0, -0.999, 10.0, True, False),
    }
...
class absoriComponent(SpectralComponent):
    _comp_name = "absori"
    _config = {
        "PhoIndex": (2.0, 0.0, 4.0, True, False),
        "nH": (1.0, 0.0, 100.0, False, False),
        "Temp_abs": (30000.0, 10000.0, 1000000.0, True, False),
        "xi": (1.0, 0.0, 5000.0, False, False),
        "Redshift": (0.0, -0.999, 10.0, True, False),
        "Fe_abund": (1.0, 0.0, 1000000.0, True, False),
    }
    _op_class = absoriOp
...
class acisabsComponent(SpectralComponent):
    _comp_name = "acisabs"
    _config = {
        "Tdays": (850.0, 0.0, 10000.0, True, False),
        "norm": (0.00722, 0.0, 1.0, True, False),
        "tauinf": (0.582, 0.0, 1.0, True, False),
        "tefold": (620.0, 1.0, 10000.0, True, False),
        "nC": (10.0, 0.0, 50.0, True, False),
        "nH": (20.0, 1.0, 50.0, True, False),
        "nO": (2.0, 0.0, 50.0, True, False),
        "nN": (1.0, 0.0, 50.0, True, False),
    }
    _op_class = acisabsOp
...
class agaussComponent(SpectralComponent):
    _comp_name = "agauss"
    _config = {
        "LineE": (10.0, 0.0, 1000000.0, False, False),
        "Sigma": (1.0, 0.0, 1000000.0, False, False),
        "norm": (1, 1e-10, 10000000000.0, False, False),
    }
    _op_class = agaussOp
...
class agauss(SpectralModel):
    def __init__(
        ...
        super().__init__(
            [agaussComponent(LineE, Sigma, norm, name, grad_method, eps)]
        )
...
class agnsedComponent(SpectralComponent):
    _comp_name = "agnsed"
    _config = {
        "mass": (10000000.0, 1.0, 10000000000.0, True, False),
        "dist": (100.0, 0.01, 1000000000.0, True, False),
        "logmdot": (-1.0, -10.0, 2.0, False, False),
        "astar": (0.0, -1.0, 0.998, True, False),
        "cosi": (0.5, 0.05, 1.0, True, False),
        "kTe_hot": (100.0, 10.0, 300.0, True, False),
        "kTe_warm": (0.2, 0.1, 0.5, False, False),
        "Gamma_hot": (1.7, 1.3, 3.0, False, False),
        "Gamma_warm": (2.7, 2.0, 10.0, False, False),
        "R_hot": (10.0, 6.0, 500.0, False, False),
        "R_warm": (20.0, 6.0, 500.0, False, False),
        "logrout": (-1.0, -3.0, 7.0, True, False),
        "Htmax": (10.0, 6.0, 10.0, True, False),
        "reprocess": (1.0, 0.0, 1.0, True, False),
        "redshift": (0.0, 0.0, 1.0, True, False),
        "norm": (1, 1e-10, 10000000000.0, False, False),
    }
    _op_class = agnsedOp
...
class agnslimComponent(SpectralComponent):
    ...
    _config = {
        "mass": (10000000.0, 1.0, 10000000000.0, True, False),
        "dist": (100.0, 0.01, 1000000000.0, True, False),
        "logmdot": (1.0, -10.0, 3.0, False, False),
        "astar": (0.0, 0.0, 0.998, True, False),
        "cosi": (0.5, 0.05, 1.0, True, False),
        "kTe_hot": (100.0, 10.0, 300.0, True, False),
        "kTe_warm": (0.2, 0.1, 0.5, False, False),
        "Gamma_hot": (2.4, 1.3, 3.0, False, False),
        "Gamma_warm": (3.0, 2.0, 10.0, False, False),
        "R_hot": (10.0, 2.0, 500.0, False, False),
        "R_warm": (20.0, 2.0, 500.0, False, False),
        "logrout": (-1.0, -3.0, 7.0, True, False),
        "rin": (-1.0, -1.0, 100.0, True, False),
        "redshift": (0.0, 0.0, 5.0, True, False),
        "norm": (1, 1e-10, 10000000000.0, False, False),
    }
    _op_class = agnslimOp
...
class apecComponent(SpectralComponent):
    _comp_name = "apec"
    _config = {
        "kT": (1.0, 0.008, 64.0, False, False),
        "Abundanc": (1.0, 0.0, 5.0, True, False),
        "Redshift": (0.0, -0.999, 10.0, True, False),
        "norm": (1, 1e-10, 10000000000.0, False, False),
    }
    _op_class = apecOp
...
class apec(SpectralModel):
    def __init__(
        ...
        super().__init__(
            [
                apecComponent(
                    kT, Abundanc, Redshift, norm, name, grad_method, eps
                )
            ]
        )
...
class bapecComponent(SpectralComponent):
    ...
    _config = {
        ...
        "Abundanc": (1.0, 0.0, 5.0, True, False),
        "Redshift": (0.0, -0.999, 10.0, True, False),
        "Velocity": (0.0, 0.0, 10000.0, True, False),
        "norm": (1, 1e-10, 10000000000.0, False, False),
    }
    _op_class = bapecOp

    def __init__(
        self, kT, Abundanc, Redshift, Velocity, norm, name, grad_method, eps
    ):
        kwargs = {
            k: v for k, v in locals().items() if k not in ("self", "__class__")
        }
...
class bbody(SpectralModel):
    def __init__(
        self, kT=None, norm=None, name=None, grad_method="f", eps=1e-7
    ):
...
class bexravComponent(SpectralComponent):
    _comp_name = "bexrav"
    _config = {
        "Gamma1": (2.0, -10.0, 10.0, False, False),
        "breakE": (10.0, 0.1, 1000.0, False, False),
        "Gamma2": (2.0, -10.0, 10.0, False, False),
        "foldE": (100.0, 1.0, 1000000.0, False, False),
        "rel_refl": (0.0, 0.0, 10.0, False, False),
        "cosIncl": (0.45, 0.05, 0.95, True, False),
        "abund": (1.0, 0.0, 1000000.0, True, False),
        "Fe_abund": (1.0, 0.0, 1000000.0, True, False),
        "Redshift": (0.0, -0.999, 10.0, True, False),
        "norm": (1, 1e-10, 10000000000.0, False, False),
    }
...
class bexrivComponent(SpectralComponent):
    ...
    _config = {
        ...
        "Gamma2": (2.0, -10.0, 10.0, False, False),
        "foldE": (100.0, 1.0, 1000000.0, False, False),
        "rel_refl": (0.0, 0.0, 1000000.0, False, False),
        "Redshift": (0.0, -0.999, 10.0, True, False),
        "abund": (1.0, 0.0, 1000000.0, True, False),
        "Fe_abund": (1.0, 0.0, 1000000.0, True, False),
        "cosIncl": (0.45, 0.05, 0.95, True, False),
        "T_disk": (30000.0, 10000.0, 1000000.0, True, False),
        "xi": (1.0, 0.0, 5000.0, False, False),
        "norm": (1, 1e-10, 10000000000.0, False, False),
    }
    _op_class = bexrivOp
...
class bkn2powComponent(SpectralComponent):
    _comp_name = "bkn2pow"
    _config = {
        "PhoIndx1": (1.0, -3.0, 10.0, False, False),
        "BreakE1": (5.0, 0.0, 1000000.0, False, False),
        "PhoIndx2": (2.0, -3.0, 10.0, False, False),
        "BreakE2": (10.0, 0.0, 1000000.0, False, False),
        "PhoIndx3": (3.0, -3.0, 10.0, False, False),
        "norm": (1, 1e-10, 10000000000.0, False, False),
    }
    _op_class = bkn2powOp
...
class bknpowerComponent(SpectralComponent):
    ...
    _config = {
        "PhoIndx1": (1.0, -3.0, 10.0, False, False),
        "BreakE": (5.0, 0.0, 1000000.0, False, False),
        "PhoIndx2": (2.0, -3.0, 10.0, False, False),
        "norm": (1, 1e-10, 10000000000.0, False, False),
    }
    ...
    def __init__(
        self, PhoIndx1, BreakE, PhoIndx2, norm, name, grad_method, eps
    ):
        kwargs = {
            k: v for k, v in locals().items() if k not in ("self", "__class__")
        }
...
class bknpower(SpectralModel):
    def __init__(
        ...
        super().__init__(
            [
                bknpowerComponent(
                    PhoIndx1, BreakE, PhoIndx2, norm, name, grad_method, eps
                )
            ]
        )
...
class bmcComponent(SpectralComponent):
    _comp_name = "bmc"
    _config = {
        "kT": (1.0, 0.0001, 200.0, False, False),
        "alpha": (1.0, 0.0001, 6.0, False, False),
        "log_A": (0.0, -8.0, 8.0, False, False),
        "norm": (1, 1e-10, 10000000000.0, False, False),
    }
    _op_class = bmcOp
...
class bmc(SpectralModel):
    def __init__(
        ...
        super().__init__(
            [bmcComponent(kT, alpha, log_A, norm, name, grad_method, eps)]
        )
...
class bremssComponent(SpectralComponent):
    _comp_name = "bremss"
    _config = {
        "kT": (7.0, 0.0001, 200.0, False, False),
        "norm": (1, 1e-10, 10000000000.0, False, False),
    }
    _op_class = bremssOp
...
class brneiComponent(SpectralComponent):
    _comp_name = "brnei"
    _config = {
        "kT": (0.5, 0.0808, 79.9, False, False),
        "kT_init": (1.0, 0.0808, 79.9, False, False),
        "Abundanc": (1.0, 0.0, 10000.0, True, False),
        "Tau": (100000000000.0, 100000000.0, 50000000000000.0, False, False),
        "Redshift": (0.0, -0.999, 10.0, True, False),
        "Velocity": (0.0, 0.0, 10000.0, True, False),
        "norm": (1, 1e-10, 10000000000.0, False, False),
    }
...
class btapecComponent(SpectralComponent):
    ...
    _config = {
        "kT": (1.0, 0.008, 64.0, False, False),
        "kTi": (1.0, 0.008, 64.0, False, False),
        "Abundanc": (1.0, 0.0, 5.0, True, False),
        "Redshift": (0.0, -0.999, 10.0, True, False),
        "Velocity": (0.0, 0.0, 10000.0, True, False),
        "norm": (1, 1e-10, 10000000000.0, False, False),
...
class bvapecComponent(SpectralComponent):
    _comp_name = "bvapec"
    _config = {
        "kT": (6.5, 0.0808, 68.447, False, False),
        "He": (1.0, 0.0, 1000.0, True, False),
        "C": (1.0, 0.0, 1000.0, True, False),
        "N": (1.0, 0.0, 1000.0, True, False),
        "O": (1.0, 0.0, 1000.0, True, False),
        "Ne": (1.0, 0.0, 1000.0, True, False),
        "Mg": (1.0, 0.0, 1000.0, True, False),
        "Al": (1.0, 0.0, 1000.0, True, False),
        "Si": (1.0, 0.0, 1000.0, True, False),
        "S": (1.0, 0.0, 1000.0, True, False),
        "Ar": (1.0, 0.0, 1000.0, True, False),
        "Ca": (1.0, 0.0, 1000.0, True, False),
        "Fe": (1.0, 0.0, 1000.0, True, False),
        "Ni": (1.0, 0.0, 1000.0, True, False),
        "Redshift": (0.0, -0.999, 10.0, True, False),
        "Velocity": (0.0, 0.0, 10000.0, True, False),
        "norm": (1, 1e-10, 10000000000.0, False, False),
    }
...
class bvrneiComponent(SpectralComponent):
    ...
    _config = {
        "kT": (0.5, 0.0808, 79.9, False, False),
        "kT_init": (1.0, 0.0808, 79.9, False, False),
        "H": (1.0, 0.0, 1.0, True, False),
        "He": (1.0, 0.0, 10000.0, True, False),
        "C": (1.0, 0.0, 10000.0, True, False),
        "N": (1.0, 0.0, 10000.0, True, False),
        "O": (1.0, 0.0, 10000.0, True, False),
        "Ne": (1.0, 0.0, 10000.0, True, False),
        "Mg": (1.0, 0.0, 10000.0, True, False),
        "Si": (1.0, 0.0, 10000.0, True, False),
        "S": (1.0, 0.0, 10000.0, True, False),
        "Ar": (1.0, 0.0, 10000.0, True, False),
        "Ca": (1.0, 0.0, 10000.0, True, False),
        "Fe": (1.0, 0.0, 10000.0, True, False),
        "Ni": (1.0, 0.0, 10000.0, True, False),
        "Tau": (100000000000.0, 100000000.0, 50000000000000.0, False, False),
        "Redshift": (0.0, -0.999, 10.0, True, False),
        "Velocity": (0.0, 0.0, 10000.0, True, False),
        "norm": (1, 1e-10, 10000000000.0, False, False),
...
class bvtapecComponent(SpectralComponent):
    ...
    _config = {
        "kT": (6.5, 0.0808, 68.447, False, False),
        "kTi": (6.5, 0.0808, 68.447, False, False),
        "He": (1.0, 0.0, 1000.0, True, False),
        "C": (1.0, 0.0, 1000.0, True, False),
        "N": (1.0, 0.0, 1000.0, True, False),
        "O": (1.0, 0.0, 1000.0, True, False),
...
class bvvapecComponent(SpectralComponent):
    ...
    _config = {
        "kT": (6.5, 0.0808, 68.447, False, False),
        "H": (1.0, 0.0, 1000.0, True, False),
        "He": (1.0, 0.0, 1000.0, True, False),
        "Li": (1.0, 0.0, 1000.0, True, False),
        "Be": (1.0, 0.0, 1000.0, True, False),
        "B": (1.0, 0.0, 1000.0, True, False),
        "C": (1.0, 0.0, 1000.0, True, False),
        "N": (1.0, 0.0, 1000.0, True, False),
        "O": (1.0, 0.0, 1000.0, True, False),
        "F": (1.0, 0.0, 1000.0, True, False),
        "Ne": (1.0, 0.0, 1000.0, True, False),
        "Na": (1.0, 0.0, 1000.0, True, False),
        "Mg": (1.0, 0.0, 1000.0, True, False),
        "Al": (1.0, 0.0, 1000.0, True, False),
        "Si": (1.0, 0.0, 1000.0, True, False),
        "P": (1.0, 0.0, 1000.0, True, False),
        "S": (1.0, 0.0, 1000.0, True, False),
        "Cl": (1.0, 0.0, 1000.0, True, False),
        "Ar": (1.0, 0.0, 1000.0, True, False),
        "K": (1.0, 0.0, 1000.0, True, False),
        "Ca": (1.0, 0.0, 1000.0, True, False),
        "Sc": (1.0, 0.0, 1000.0, True, False),
        "Ti": (1.0, 0.0, 1000.0, True, False),
        "V": (1.0, 0.0, 1000.0, True, False),
        "Cr": (1.0, 0.0, 1000.0, True, False),
        "Mn": (1.0, 0.0, 1000.0, True, False),
        "Fe": (1.0, 0.0, 1000.0, True, False),
        "Co": (1.0, 0.0, 1000.0, True, False),
        "Ni": (1.0, 0.0, 1000.0, True, False),
        "Cu": (1.0, 0.0, 1000.0, True, False),
        "Zn": (1.0, 0.0, 1000.0, True, False),
        "Redshift": (0.0, -0.999, 10.0, True, False),
        "Velocity": (0.0, 0.0, 10000.0, True, False),
        "norm": (1, 1e-10, 10000000000.0, False, False),
    }
...
class bwcyclComponent(SpectralComponent):
    _comp_name = "bwcycl"
    _config = {
        "Radius": (10.0, 5.0, 20.0, True, False),
        "Mass": (1.4, 1.0, 3.0, True, False),
        "csi": (1.5, 0.01, 20.0, False, False),
        "delta": (1.8, 0.01, 20.0, False, False),
        "B": (4.0, 0.01, 100.0, False, False),
        "Mdot": (1.0, 1e-06, 1000000.0, False, False),
        "Te": (5.0, 0.1, 100.0, False, False),
        "r0": (44.0, 10.0, 1000.0, False, False),
        "D": (5.0, 1.0, 20.0, True, False),
        "BBnorm": (0.0, 0.0, 100.0, True, False),
        "CYCnorm": (1.0, -1.0, 100.0, True, False),
        "FFnorm": (1.0, -1.0, 100.0, True, False),
        "norm": (1, 1e-10, 10000000000.0, False, False),
    }
    _op_class = bwcyclOp
...
class c6meklComponent(SpectralComponent):
    _comp_name = "c6mekl"
    _config = {
        "CPcoef1": (1.0, -1.0, 1.0, False, False),
        "CPcoef2": (0.5, -1.0, 1.0, False, False),
        "CPcoef3": (0.5, -1.0, 1.0, False, False),
        "CPcoef4": (0.5, -1.0, 1.0, False, False),
        "CPcoef5": (0.5, -1.0, 1.0, False, False),
        "CPcoef6": (0.5, -1.0, 1.0, False, False),
        "nH": (1.0, 1e-06, 1e20, True, False),
        "abundanc": (1.0, 0.0, 10.0, True, False),
        "Redshift": (0.0, -0.999, 10.0, True, False),
        "switch": (1, None, None, True, False),
        "norm": (1, 1e-10, 10000000000.0, False, False),
    }
    _op_class = c6meklOp
...
class c6pvmklComponent(SpectralComponent):
    ...
    _config = {
        ...
        "CPcoef6": (0.5, -1.0, 1.0, False, False),
        "nH": (1.0, 1e-06, 1e20, True, False),
        "He": (1.0, 0.0, 10.0, True, False),
        "C": (1.0, 0.0, 10.0, True, False),
        "N": (1.0, 0.0, 10.0, True, False),
        "O": (1.0, 0.0, 10.0, True, False),
        "Ne": (1.0, 0.0, 10.0, True, False),
        "Na": (1.0, 0.0, 10.0, True, False),
        "Mg": (1.0, 0.0, 10.0, True, False),
        "Al": (1.0, 0.0, 10.0, True, False),
        "Si": (1.0, 0.0, 10.0, True, False),
        "S": (1.0, 0.0, 10.0, True, False),
        "Ar": (1.0, 0.0, 10.0, True, False),
        "Ca": (1.0, 0.0, 10.0, True, False),
        "Fe": (1.0, 0.0, 10.0, True, False),
        "Ni": (1.0, 0.0, 10.0, True, False),
        "Redshift": (0.0, -0.999, 10.0, True, False),
        "switch": (1, None, None, True, False),
        "norm": (1, 1e-10, 10000000000.0, False, False),
    }
...
class carbatmComponent(SpectralComponent):
    _comp_name = "carbatm"
    _config = {
        "T": (2.0, 1.0, 4.0, False, False),
        "NSmass": (1.4, 0.6, 2.8, False, False),
        "NSrad": (10.0, 6.0, 23.0, False, False),
        "norm": (1, 1e-10, 10000000000.0, False, False),
    }
    _op_class = carbatmOp
...
class carbatm(SpectralModel):
    def __init__(
        ...
        super().__init__(
            [carbatmComponent(T, NSmass, NSrad, norm, name, grad_method, eps)]
        )
...
class cemeklComponent(SpectralComponent):
    _comp_name = "cemekl"
    _config = {
        "alpha": (1.0, 0.01, 20.0, True, False),
        "Tmax": (1.0, 0.01, 100.0, False, False),
        "nH": (1.0, 1e-06, 1e20, True, False),
        "abundanc": (1.0, 0.0, 10.0, True, False),
        "Redshift": (0.0, -0.999, 10.0, True, False),
        "switch": (1, 0.0, 1.0, True, False),
        "norm": (1, 1e-10, 10000000000.0, False, False),
    }
    _op_class = cemeklOp
...
class cflowComponent(SpectralComponent):
    _comp_name = "cflow"
    _config = {
        "slope": (0.0, -5.0, 5.0, False, False),
        "lowT": (0.1, 0.0808, 79.9, False, False),
        "highT": (4.0, 0.0808, 79.9, False, False),
        "Abundanc": (1.0, 0.0, 5.0, False, False),
        "redshift": (0.1, 1e-10, 10.0, True, False),
        "norm": (1, 1e-10, 10000000000.0, False, False),
    }
    _op_class = cflowOp
...
class cfluxComponent(SpectralComponent):
    _comp_name = "cflux"
    _config = {
        "Emin": (0.5, 0.0, 1000000.0, True, False),
        "Emax": (10.0, 0.0, 1000000.0, True, False),
        "lg10Flux": (-12.0, -100.0, 100.0, False, False),
    }
    _op_class = cfluxOp
...
class cflux(SpectralModel):
    def __init__(
        ...
        super().__init__(
            [cfluxComponent(Emin, Emax, lg10Flux, name, grad_method, eps)]
        )
...
class cgluminComponent(SpectralComponent):
    ...
    _config = {
        "Emin": (0.5, 0.0, 1000000.0, True, False),
        "Emax": (10.0, 0.0, 1000000.0, True, False),
        "Distance": (10.0, 0.0, 1000000.0, True, False),
        "lg10Lum": (40.0, -100.0, 100.0, False, False),
    }
    _op_class = cgluminOp
...
class cglumin(SpectralModel):
    def __init__(
        ...
        super().__init__(
            [
                cgluminComponent(
                    Emin, Emax, Distance, lg10Lum, name, grad_method, eps
                )
            ]
        )
...
class clumin(SpectralModel):
    def __init__(
        ...
        super().__init__(
            [
                cluminComponent(
                    Emin, Emax, Redshift, lg10Lum, name, grad_method, eps
                )
            ]
        )
...
class compLSComponent(SpectralComponent):
    _comp_name = "compLS"
    _config = {
        "kT": (2.0, 0.001, 20.0, False, False),
        "tau": (10.0, 0.0001, 200.0, False, False),
        "norm": (1, 1e-10, 10000000000.0, False, False),
    }
    _op_class = compLSOp
...
class compLS(SpectralModel):
    def __init__(
        ...
        super().__init__(
            [compLSComponent(kT, tau, norm, name, grad_method, eps)]
        )
...
class compPSComponent(SpectralComponent):
    _comp_name = "compPS"
    _config = {
        "kTe": (100.0, 20.0, 100000.0, False, False),
        "EleIndex": (2.0, 0.0, 5.0, True, False),
        "Gmin": (-1.0, -1.0, 10.0, True, False),
        "Gmax": (1000.0, 10.0, 10000.0, True, False),
        "kTbb": (0.1, 0.001, 10.0, True, False),
        "tau_y": (1.0, 0.05, 3.0, False, False),
        "geom": (0.0, -5.0, 4.0, True, False),
        "HovR_cyl": (1.0, 0.5, 2.0, True, False),
        "cosIncl": (0.5, 0.05, 0.95, True, False),
        "cov_frac": (1.0, 0.0, 1.0, True, False),
        "rel_refl": (0.0, 0.0, 10000.0, True, False),
        "Fe_ab_re": (1.0, 0.1, 10.0, True, False),
        "Me_ab": (1.0, 0.1, 10.0, True, False),
        "xi": (0.0, 0.0, 100000.0, True, False),
        "Tdisk": (1000000.0, 10000.0, 1000000.0, True, False),
        "Betor10": (-10.0, -10.0, 10.0, True, False),
        "Rin": (10.0, 6.001, 10000.0, True, False),
        "Rout": (1000.0, 0.0, 1000000.0, True, False),
        "Redshift": (0.0, -0.999, 10.0, True, False),
        "norm": (1, 1e-10, 10000000000.0, False, False),
    }
    _op_class = compPSOp
...
class compSTComponent(SpectralComponent):
    _comp_name = "compST"
    _config = {
        "kT": (2.0, 0.001, 100.0, False, False),
        "tau": (10.0, 0.0001, 200.0, False, False),
        "norm": (1, 1e-10, 10000000000.0, False, False),
    }
    _op_class = compSTOp
...
class compST(SpectralModel):
    def __init__(
        ...
        super().__init__(
            [compSTComponent(kT, tau, norm, name, grad_method, eps)]
        )
...
class compTTComponent(SpectralComponent):
    ...
    _config = {
        "Redshift": (0.0, -0.999, 10.0, True, False),
        "T0": (0.1, 0.001, 100.0, False, False),
        "kT": (50.0, 2.0, 500.0, False, False),
        "taup": (1.0, 0.01, 200.0, False, False),
        "approx": (1.0, 0.0, 200.0, True, False),
        "norm": (1, 1e-10, 10000000000.0, False, False),
    }
    _op_class = compTTOp

    def __init__(
        self, Redshift, T0, kT, taup, approx, norm, name, grad_method, eps
    ):
        kwargs = {
            k: v for k, v in locals().items() if k not in ("self", "__class__")
        }
...
class compbbComponent(SpectralComponent):
    ...
    _config = {
        "kT": (1.0, 0.0001, 200.0, False, False),
        "kTe": (50.0, 1.0, 200.0, True, False),
        "tau": (0.1, 0.0, 10.0, False, False),
        "norm": (1, 1e-10, 10000000000.0, False, False),
    }
    _op_class = compbbOp
...
class compbb(SpectralModel):
    def __init__(
        ...
        super().__init__(
            [compbbComponent(kT, kTe, tau, norm, name, grad_method, eps)]
        )
...
class compmagComponent(SpectralComponent):
    _comp_name = "compmag"
    _config = {
        "kTbb": (1.0, 0.2, 10.0, False, False),
        "kTe": (5.0, 0.2, 2000.0, False, False),
        "tau": (0.5, 0.0, 10.0, False, False),
        "eta": (0.5, 0.01, 1.0, False, False),
        "beta0": (0.57, 0.0001, 1.0, False, False),
        "r0": (0.25, 0.0001, 100.0, False, False),
        "A": (0.001, 0.0, 1.0, True, False),
        "betaflag": (1.0, 0.0, 2.0, True, False),
        "norm": (1, 1e-10, 10000000000.0, False, False),
    }
    _op_class = compmagOp
...
class comptbComponent(SpectralComponent):
    _comp_name = "comptb"
    _config = {
        "kTs": (1.0, 0.1, 10.0, False, False),
        "gamma": (3.0, 1.0, 10.0, True, False),
        "alpha": (2.0, 0.0, 400.0, False, False),
        "delta": (20.0, 0.0, 200.0, False, False),
        "kTe": (5.0, 0.2, 2000.0, False, False),
        "log_A": (0.0, -8.0, 8.0, False, False),
        "norm": (1, 1e-10, 10000000000.0, False, False),
    }
...
class compthComponent(SpectralComponent):
    _comp_name = "compth"
    _config = {
        "theta": (1.0, 1e-06, 1000000.0, False, False),
        "showbb": (1.0, 0.0, 10000.0, True, False),
        "kT_bb": (200.0, 1.0, 400000.0, True, False),
        "RefOn": (-1.0, -2.0, 2.0, True, False),
        "tau_p": (0.1, 0.0001, 10.0, True, False),
        "radius": (10000000.0, 100000.0, 1e16, True, False),
        "g_min": (1.3, 1.2, 1000.0, True, False),
        "g_max": (1000.0, 5.0, 10000.0, True, False),
        "G_inj": (2.0, 0.0, 5.0, True, False),
        "pairinj": (0.0, 0.0, 1.0, True, False),
        "cosIncl": (0.5, 0.05, 0.95, True, False),
        "Refl": (1.0, 0.0, 2.0, True, False),
        "Fe_abund": (1.0, 0.1, 10.0, True, False),
        "Ab_met": (1.0, 0.1, 10.0, True, False),
        "T_disk": (1000000.0, 10000.0, 1000000.0, True, False),
        "xi": (0.0, 0.0, 5000.0, False, False),
        "Beta": (-10.0, -10.0, 10.0, True, False),
        "Rin": (10.0, 6.001, 10000.0, True, False),
        "Rout": (1000.0, 0.0, 1000000.0, True, False),
        "redshift": (0.0, 0.0, 4.0, True, False),
        "norm": (1, 1e-10, 10000000000.0, False, False),
    }
    _op_class = compthOp
...
class cpfluxComponent(SpectralComponent):
    ...
    _config = {
        "Emin": (0.5, 0.0, 1000000.0, True, False),
        "Emax": (10.0, 0.0, 1000000.0, True, False),
        "Flux": (1.0, 0.0, 10000000000.0, False, False),
    }
    _op_class = cpfluxOp
...
class cpflux(SpectralModel):
    def __init__(
        ...
        super().__init__(
            [cpfluxComponent(Emin, Emax, Flux, name, grad_method, eps)]
        )
...
class cphComponent(SpectralComponent):
    _comp_name = "cph"
    _config = {
        "peakT": (2.2, 0.1, 100.0, False, False),
        "Abund": (1.0, 0.0, 1000.0, True, False),
        "Redshift": (0.0, 0.0, 50.0, True, False),
        "switch": (1, None, None, True, False),
        "norm": (1, 1e-10, 10000000000.0, False, False),
    }
    _op_class = cphOp
    ...
    def __init__(
        self, peakT, Abund, Redshift, switch, norm, name, grad_method, eps
    ):
        kwargs = {
            k: v for k, v in locals().items() if k not in ("self", "__class__")
        }
...
class cplinearComponent(SpectralComponent):
    _comp_name = "cplinear"
    _config = {
        "energy00": (0.5, 0.0, 10.0, True, False),
        "energy01": (1.0, 0.0, 10.0, True, False),
        "energy02": (1.5, 0.0, 10.0, True, False),
        "energy03": (2.0, 0.0, 10.0, True, False),
        "energy04": (3.0, 0.0, 10.0, True, False),
        "energy05": (4.0, 0.0, 10.0, True, False),
        "energy06": (5.0, 0.0, 10.0, True, False),
        "energy07": (6.0, 0.0, 10.0, True, False),
        "energy08": (7.0, 0.0, 10.0, True, False),
        "energy09": (8.0, 0.0, 10.0, True, False),
        "log_rate00": (0.0, -20.0, 20.0, True, False),
        "log_rate01": (1.0, -20.0, 20.0, True, False),
        "log_rate02": (0.0, -20.0, 20.0, True, False),
        "log_rate03": (1.0, -20.0, 20.0, True, False),
        "log_rate04": (0.0, -20.0, 20.0, True, False),
        "log_rate05": (1.0, -20.0, 20.0, True, False),
        "log_rate06": (0.0, -20.0, 20.0, True, False),
        "log_rate07": (1.0, -20.0, 20.0, True, False),
        "log_rate08": (0.0, -20.0, 20.0, True, False),
        "log_rate09": (1.0, -20.0, 20.0, True, False),
        "norm": (1, 1e-10, 10000000000.0, False, False),
    }
...
class cutoffplComponent(SpectralComponent):
    ...
    _config = {
        ...
        "HighECut": (15.0, 0.01, 500.0, False, False),
        "norm": (1, 1e-10, 10000000000.0, False, False),
    }
...
class cutoffpl(SpectralModel):
    def __init__(
        ...
        super().__init__(
            [
                cutoffplComponent(
                    PhoIndex, HighECut, norm, name, grad_method, eps
                )
            ]
        )
...
class cyclabsComponent(SpectralComponent):
    _comp_name = "cyclabs"
    _config = {
        "Depth0": (2.0, 0.0, 100.0, False, False),
        "E0": (30.0, 1.0, 100.0, False, False),
        "Width0": (10.0, 1.0, 100.0, True, False),
        "Depth2": (0.0, 0.0, 100.0, True, False),
        "Width2": (20.0, 1.0, 100.0, True, False),
    }
    _op_class = cyclabsOp

    def __init__(
        self, Depth0, E0, Width0, Depth2, Width2, name, grad_method, eps
    ):
        kwargs = {
            k: v for k, v in locals().items() if k not in ("self", "__class__")
        }
...
class cyclabs(SpectralModel):
    def __init__(
        ...
        super().__init__(
            [
                cyclabsComponent(
                    Depth0, E0, Width0, Depth2, Width2, name, grad_method, eps
                )
            ]
        )
...
class diskComponent(SpectralComponent):
    _comp_name = "disk"
    _config = {
        "accrate": (1.0, 0.0001, 10.0, False, False),
        "CenMass": (1.4, 0.1, 20.0, True, False),
        "Rinn": (1.03, 1.0, 1.04, True, False),
        "norm": (1, 1e-10, 10000000000.0, False, False),
    }
    _op_class = diskOp
...
class disk(SpectralModel):
    def __init__(
        ...
        super().__init__(
            [
                diskComponent(
                    accrate, CenMass, Rinn, norm, name, grad_method, eps
                )
            ]
        )
...
class diskbbComponent(SpectralComponent):
    _comp_name = "diskbb"
    _config = {
        "Tin": (1.0, 0.0, 1000.0, False, False),
        "norm": (1, 1e-10, 10000000000.0, False, False),
    }
    _op_class = diskbbOp
...
class diskbb(SpectralModel):
    def __init__(
        self, Tin=None, norm=None, name=None, grad_method="f", eps=1e-7
    ):
...
class diskirComponent(SpectralComponent):
    _comp_name = "diskir"
    _config = {
        "kT_disk": (1.0, 0.01, 5.0, False, False),
        "Gamma": (1.7, 1.001, 10.0, False, False),
        "kT_e": (100.0, 1.0, 1000.0, False, False),
        "LcovrLd": (0.1, 0.0, 10.0, False, False),
        "fin": (0.1, 0.0, 1.0, True, False),
        "rirr": (1.2, 1.0001, 10.0, False, False),
        "fout": (0.0001, 0.0, 0.1, False, False),
        "logrout": (5.0, 3.0, 7.0, False, False),
        "norm": (1, 1e-10, 10000000000.0, False, False),
    }
    _op_class = diskirOp
...
class disklineComponent(SpectralComponent):
    _comp_name = "diskline"
    _config = {
        "LineE": (6.7, 0.0, 100.0, False, False),
        "Betor10": (-2.0, -10.0, 20.0, True, False),
        "Rin_M": (10.0, 6.0, 10000.0, True, False),
        "Rout_M": (1000.0, 0.0, 10000000.0, True, False),
        "Incl": (30.0, 0.0, 90.0, False, False),
        "norm": (1, 1e-10, 10000000000.0, False, False),
    }
    _op_class = disklineOp

    def __init__(
        self, LineE, Betor10, Rin_M, Rout_M, Incl, norm, name, grad_method, eps
    ):
        kwargs = {
            k: v for k, v in locals().items() if k not in ("self", "__class__")
        }
...
class diskmComponent(SpectralComponent):
    ...
    _config = {
        "accrate": (1.0, 0.0001, 10.0, False, False),
        "NSmass": (1.4, 0.1, 20.0, True, False),
        "Rinn": (1.03, 1.0, 1.04, True, False),
        "alpha": (1.0, 0.001, 20.0, True, False),
        "norm": (1, 1e-10, 10000000000.0, False, False),
    }
    _op_class = diskmOp

    def __init__(
        self, accrate, NSmass, Rinn, alpha, norm, name, grad_method, eps
    ):
        kwargs = {
            k: v for k, v in locals().items() if k not in ("self", "__class__")
        }
...
class diskm(SpectralModel):
    def __init__(
        ...
        super().__init__(
            [
                diskmComponent(
                    accrate, NSmass, Rinn, alpha, norm, name, grad_method, eps
                )
            ]
        )
...
class diskpbbComponent(SpectralComponent):
    _comp_name = "diskpbb"
    _config = {
        "Tin": (1.0, 0.1, 10.0, False, False),
        "p": (0.75, 0.5, 1.0, False, False),
        "norm": (1, 1e-10, 10000000000.0, False, False),
    }
    _op_class = diskpbbOp
...
class diskpbb(SpectralModel):
    def __init__(
        self, Tin=None, p=None, norm=None, name=None, grad_method="f", eps=1e-7
    ):
        super().__init__(
            [diskpbbComponent(Tin, p, norm, name, grad_method, eps)]
        )
...
class diskpnComponent(SpectralComponent):
    _comp_name = "diskpn"
    _config = {
        "T_max": (1.0, 0.0001, 200.0, False, False),
        "R_in": (6.0, 6.0, 1000.0, False, False),
        "norm": (1, 1e-10, 10000000000.0, False, False),
    }
    _op_class = diskpnOp
...
class diskpn(SpectralModel):
    def __init__(
        ...
        super().__init__(
            [diskpnComponent(T_max, R_in, norm, name, grad_method, eps)]
        )
...
class dustComponent(SpectralComponent):
    _comp_name = "dust"
    _config = {
        "Frac": (0.066, 0.0, 1.0, True, False),
        "Halosz": (2.0, 0.0, 100000.0, True, False),
    }
    _op_class = dustOp
...
class dust(SpectralModel):
    def __init__(
        self, Frac=None, Halosz=None, name=None, grad_method="f", eps=1e-7
    ):
...
class edgeComponent(SpectralComponent):
    _comp_name = "edge"
    _config = {
        "edgeE": (7.0, 0.0, 100.0, False, False),
        "MaxTau": (1.0, 0.0, 10.0, False, False),
    }
    _op_class = edgeOp
...
class edge(SpectralModel):
    def __init__(
        self, edgeE=None, MaxTau=None, name=None, grad_method="f", eps=1e-7
    ):
        super().__init__(
            [edgeComponent(edgeE, MaxTau, name, grad_method, eps)]
        )
...
class eplogparComponent(SpectralComponent):
    _comp_name = "eplogpar"
    _config = {
        "Ep": (0.1, 1e-10, 10000.0, False, False),
        "beta": (0.2, -4.0, 4.0, False, False),
        "norm": (1, 1e-10, 10000000000.0, False, False),
    }
...
class eplogpar(SpectralModel):
    def __init__(
        ...
        super().__init__(
            [eplogparComponent(Ep, beta, norm, name, grad_method, eps)]
        )
...
class eqpairComponent(SpectralComponent):
    _comp_name = "eqpair"
    _config = {
        "l_hovl_s": (1.0, 1e-06, 1000000.0, False, False),
        "l_bb": (100.0, 0.0, 10000.0, False, False),
        "kT_bb": (200.0, 1.0, 400000.0, True, False),
        "l_ntol_h": (0.5, 0.0, 0.9999, False, False),
        "tau_p": (0.1, 0.0001, 10.0, True, False),
        "radius": (10000000.0, 100000.0, 1e16, True, False),
        "g_min": (1.3, 1.2, 1000.0, True, False),
        "g_max": (1000.0, 5.0, 10000.0, True, False),
...
class equilComponent(SpectralComponent):
    _comp_name = "equil"
    _config = {
        "kT": (1.0, 0.0808, 79.9, False, False),
        "Abundanc": (1.0, 0.0, 10000.0, True, False),
        "Redshift": (0.0, -0.999, 10.0, True, False),
        "norm": (1, 1e-10, 10000000000.0, False, False),
    }
...
class expdecComponent(SpectralComponent):
    _comp_name = "expdec"
    _config = {
        "factor": (1.0, 0.0, 100.0, False, False),
        "norm": (1, 1e-10, 10000000000.0, False, False),
    }
    _op_class = expdecOp
...
class expdec(SpectralModel):
    def __init__(
        self, factor=None, norm=None, name=None, grad_method="f", eps=1e-7
    ):
        super().__init__(
            [expdecComponent(factor, norm, name, grad_method, eps)]
        )
...
class expfacComponent(SpectralComponent):
    _comp_name = "expfac"
    _config = {
        "Ampl": (1.0, 0.0, 1000000.0, False, False),
        "Factor": (1.0, 0.0, 1000000.0, False, False),
        "StartE": (0.5, 0.0, 1000000.0, True, False),
    }
    _op_class = expfacOp
...
class expfac(SpectralModel):
    def __init__(
        ...
        super().__init__(
            [expfacComponent(Ampl, Factor, StartE, name, grad_method, eps)]
        )
...
class ezdiskbbComponent(SpectralComponent):
    _comp_name = "ezdiskbb"
    _config = {
        "T_max": (1.0, 0.01, 100.0, False, False),
        "norm": (1, 1e-10, 10000000000.0, False, False),
    }
...
class ezdiskbb(SpectralModel):
    def __init__(
        self, T_max=None, norm=None, name=None, grad_method="f", eps=1e-7
    ):
        super().__init__(
            [ezdiskbbComponent(T_max, norm, name, grad_method, eps)]
        )
...
class gabsComponent(SpectralComponent):
    _comp_name = "gabs"
    _config = {
        "LineE": (1.0, 0.0, 1000000.0, False, False),
        "Sigma": (0.01, 0.0, 20.0, False, False),
        "Strength": (1.0, 0.0, 1000000.0, False, False),
    }
    _op_class = gabsOp
...
class gabs(SpectralModel):
    def __init__(
        ...
        super().__init__(
            [gabsComponent(LineE, Sigma, Strength, name, grad_method, eps)]
        )
...
class gademComponent(SpectralComponent):
    _comp_name = "gadem"
    _config = {
        "Tmean": (4.0, 0.01, 20.0, True, False),
        "Tsigma": (0.1, 0.01, 100.0, False, False),
        "nH": (1.0, 1e-06, 1e20, True, False),
        "abundanc": (1.0, 0.0, 10.0, True, False),
        "Redshift": (0.0, -0.999, 10.0, True, False),
        "switch": (2, None, None, True, False),
        "norm": (1, 1e-10, 10000000000.0, False, False),
    }
    _op_class = gademOp
...
class gaussianComponent(SpectralComponent):
    _comp_name = "gaussian"
    _config = {
        "LineE": (6.5, 0.0, 1000000.0, False, False),
        "Sigma": (0.1, 0.0, 20.0, False, False),
        "norm": (1, 1e-10, 10000000000.0, False, False),
    }
...
class gaussian(SpectralModel):
    def __init__(
        ...
        super().__init__(
            [gaussianComponent(LineE, Sigma, norm, name, grad_method, eps)]
        )
...
class gneiComponent(SpectralComponent):
    ...
    _config = {
        ...
        "Abundanc": (1.0, 0.0, 10000.0, True, False),
        "Tau": (100000000000.0, 100000000.0, 50000000000000.0, False, False),
        "meankT": (1.0, 0.0808, 79.9, False, False),
        "Redshift": (0.0, -0.999, 10.0, True, False),
        "norm": (1, 1e-10, 10000000000.0, False, False),
    }
    _op_class = gneiOp
    ...
    def __init__(
        self, kT, Abundanc, Tau, meankT, Redshift, norm, name, grad_method, eps
    ):
        kwargs = {
            k: v for k, v in locals().items() if k not in ("self", "__class__")
        }
...
class gradComponent(SpectralComponent):
    _comp_name = "grad"
    _config = {
        "D": (10.0, 0.0, 10000.0, True, False),
        "i": (0.0, 0.0, 90.0, True, False),
        "Mass": (1.0, 0.0, 100.0, False, False),
        "Mdot": (1.0, 0.0, 100.0, False, False),
        "TclovTef": (1.7, 1.0, 10.0, True, False),
        "refflag": (1.0, -1.0, 1.0, True, False),
        "norm": (1, 1e-10, 10000000000.0, False, False),
    }
    _op_class = gradOp

    def __init__(
        self, D, i, Mass, Mdot, TclovTef, refflag, norm, name, grad_method, eps
    ):
        kwargs = {
            k: v for k, v in locals().items() if k not in ("self", "__class__")
        }
...
class grbcompComponent(SpectralComponent):
    _comp_name = "grbcomp"
    _config = {
        "kTs": (1.0, 0.0, 20.0, False, False),
        "gamma": (3.0, 0.0, 10.0, False, False),
        "kTe": (100.0, 0.2, 2000.0, False, False),
        "tau": (5.0, 0.0, 200.0, False, False),
        "beta": (0.2, 0.0, 1.0, False, False),
        "fbflag": (0.0, 0.0, 1.0, True, False),
        "log_A": (5.0, -8.0, 8.0, True, False),
        "z": (0.0, 0.0, 10.0, True, False),
        "a_boost": (5.0, 0.0, 30.0, True, False),
        "norm": (1, 1e-10, 10000000000.0, False, False),
    }
    _op_class = grbcompOp
...
class grbjetComponent(SpectralComponent):
    _comp_name = "grbjet"
    _config = {
        "thobs": (5.0, 0.0, 30.0, True, False),
        "thjet": (10.0, 2.0, 20.0, True, False),
        "gamma": (200.0, 1.0, 500.0, False, False),
        "r12": (1.0, 0.1, 100.0, True, False),
        "p1": (0.0, -2.0, 1.0, False, False),
        "p2": (1.5, 1.1, 10.0, False, False),
        "E0": (1.0, 0.1, 1000.0, False, False),
        "delta": (0.2, 0.01, 1.5, True, False),
        "index_pl": (0.8, 0.0, 1.5, True, False),
        "ecut": (20.0, 0.1, 1000.0, True, False),
        "ktbb": (1.0, 0.1, 1000.0, True, False),
        "model": (1, None, None, True, False),
        "redshift": (2.0, 0.001, 10.0, True, False),
        "norm": (1, 1e-10, 10000000000.0, False, False),
    }
    _op_class = grbjetOp
...
class grbmComponent(SpectralComponent):
    ...
    _config = {
        ...
        "tem": (300.0, 10.0, 10000.0, False, False),
        "norm": (1, 1e-10, 10000000000.0, False, False),
    }
    _op_class = grbmOp
...
class grbm(SpectralModel):
    def __init__(
        ...
        super().__init__(
            [grbmComponent(alpha, beta, tem, norm, name, grad_method, eps)]
        )
...
class gsmoothComponent(SpectralComponent):
    _comp_name = "gsmooth"
    _config = {
        "Sig_6keV": (1.0, 0.0, 20.0, False, False),
        "Index": (0.0, -1.0, 1.0, True, False),
    }
    _op_class = gsmoothOp
...
class gsmooth(SpectralModel):
    def __init__(
        self, Sig_6keV=None, Index=None, name=None, grad_method="f", eps=1e-7
    ):
        super().__init__(
            [gsmoothComponent(Sig_6keV, Index, name, grad_method, eps)]
        )
...
class hatmComponent(SpectralComponent):
    _comp_name = "hatm"
    _config = {
        "T": (3.0, 0.5, 10.0, False, False),
        "NSmass": (1.4, 0.6, 2.8, False, False),
        "NSrad": (10.0, 5.0, 23.0, False, False),
        "norm": (1, 1e-10, 10000000000.0, False, False),
    }
    _op_class = hatmOp
...
class hatm(SpectralModel):
    def __init__(
        ...
        super().__init__(
            [hatmComponent(T, NSmass, NSrad, norm, name, grad_method, eps)]
        )
...
class heilinComponent(SpectralComponent):
    _comp_name = "heilin"
    _config = {
        "nHeI": (1e-05, 0.0, 1000000.0, False, False),
        "b": (10.0, 1.0, 1000000.0, False, False),
        "z": (0.0, -0.001, 100000.0, False, False),
    }
    _op_class = heilinOp
...
class heilin(SpectralModel):
    def __init__(
        self, nHeI=None, b=None, z=None, name=None, grad_method="f", eps=1e-7
    ):
...
class highecutComponent(SpectralComponent):
    _comp_name = "highecut"
    _config = {
        "cutoffE": (10.0, 0.0001, 1000000.0, False, False),
        "foldE": (15.0, 0.0001, 1000000.0, False, False),
    }
...
class highecut(SpectralModel):
    def __init__(
        self, cutoffE=None, foldE=None, name=None, grad_method="f", eps=1e-7
    ):
        super().__init__(
            [highecutComponent(cutoffE, foldE, name, grad_method, eps)]
        )
...
class hreflComponent(SpectralComponent):
    _comp_name = "hrefl"
    _config = {
        "thetamin": (0.0, 0.0, 90.0, True, False),
        "thetamax": (90.0, 0.0, 90.0, True, False),
        "thetaobs": (60.0, 0.0, 90.0, False, False),
        "Feabun": (1.0, 0.0, 200.0, True, False),
        "FeKedge": (7.11, 7.0, 10.0, True, False),
        "Escfrac": (1.0, 0.0, 1000.0, False, False),
        "covfac": (1.0, 0.0, 1000.0, False, False),
        "Redshift": (0.0, -0.999, 10.0, True, False),
    }
    _op_class = hreflOp
...
class ireflectComponent(SpectralComponent):
    _comp_name = "ireflect"
    _config = {
        "rel_refl": (0.0, -1.0, 1000000.0, False, False),
        "Redshift": (0.0, -0.999, 10.0, True, False),
        "abund": (1.0, 0.0, 1000000.0, True, False),
        "Fe_abund": (1.0, 0.0, 1000000.0, True, False),
        "cosIncl": (0.45, 0.05, 0.95, True, False),
...
class ismabsComponent(SpectralComponent):
    _comp_name = "ismabs"
    _config = {
        "H": (0.1, 0.0, 1000000.0, False, False),
        "He_II": (0.0, 0.0, 1000000.0, True, False),
        "C_I": (33.1, 0.0, 1000000.0, False, False),
        "C_II": (0.0, 0.0, 1000000.0, True, False),
        "C_III": (0.0, 0.0, 1000000.0, True, False),
        "N_I": (8.32, 0.0, 1000000.0, False, False),
        "N_II": (0.0, 0.0, 1000000.0, True, False),
        "N_III": (0.0, 0.0, 1000000.0, True, False),
        "O_I": (67.6, 0.0, 1000000.0, False, False),
        "O_II": (0.0, 0.0, 1000000.0, True, False),
        "O_III": (0.0, 0.0, 1000000.0, True, False),
        "Ne_I": (12.0, 0.0, 1000000.0, False, False),
        "Ne_II": (0.0, 0.0, 1000000.0, True, False),
        "Ne_III": (0.0, 0.0, 1000000.0, True, False),
        "Mg_I": (3.8, 0.0, 1000000.0, False, False),
        "Mg_II": (0.0, 0.0, 1000000.0, True, False),
        "Mg_III": (0.0, 0.0, 1000000.0, True, False),
        "Si_I": (3.35, 0.0, 1000000.0, False, False),
        "Si_II": (0.0, 0.0, 1000000.0, True, False),
        "Si_III": (0.0, 0.0, 1000000.0, True, False),
        "S_I": (2.14, 0.0, 1000000.0, False, False),
        "S_II": (0.0, 0.0, 1000000.0, True, False),
        "S_III": (0.0, 0.0, 1000000.0, True, False),
        "Ar_I": (0.25, 0.0, 1000000.0, False, False),
        "Ar_II": (0.0, 0.0, 1000000.0, True, False),
        "Ar_III": (0.0, 0.0, 1000000.0, True, False),
        "Ca_I": (0.22, 0.0, 1000000.0, False, False),
        "Ca_II": (0.0, 0.0, 1000000.0, True, False),
        "Ca_III": (0.0, 0.0, 1000000.0, True, False),
        "Fe": (3.16, 0.0, 1000000.0, False, False),
        "redshift": (0.0, -1.0, 10.0, True, False),
    }
    _op_class = ismabsOp
...
class ismdustComponent(SpectralComponent):
    _comp_name = "ismdust"
    _config = {
        "msil": (1.0, 0.0, 100000.0, False, False),
        "mgra": (1.0, 0.0, 100000.0, False, False),
        "redshift": (0.0, -1.0, 10.0, True, False),
    }
    _op_class = ismdustOp
...
class ismdust(SpectralModel):
    def __init__(
        ...
        super().__init__(
            [ismdustComponent(msil, mgra, redshift, name, grad_method, eps)]
        )
...
class jetComponent(SpectralComponent):
    _comp_name = "jet"
    _config = {
        "mass": (1000000000.0, 1.0, 10000000000.0, True, False),
        "Dco": (3350.6, 1.0, 100000000.0, True, False),
        "log_mdot": (-1.0, -5.0, 2.0, False, False),
        "thetaobs": (3.0, 0.0, 90.0, True, False),
        "BulkG": (13.0, 1.0, 100.0, True, False),
        "phi": (0.1, 0.01, 100.0, True, False),
        "zdiss": (1275.0, 10.0, 10000.0, True, False),
        "B": (2.6, 0.01, 15.0, True, False),
        "logPrel": (43.3, 40.0, 48.0, True, False),
        "gmin_inj": (1.0, 1.0, 1000.0, True, False),
        "gbreak": (300.0, 10.0, 10000.0, True, False),
        "gmax": (3000.0, 1000.0, 1000000.0, True, False),
        "s1": (1.0, -1.0, 1.0, True, False),
        "s2": (2.7, 1.0, 5.0, True, False),
        "z": (0.0, 0.0, 10.0, True, False),
        "norm": (1, 1e-10, 10000000000.0, False, False),
    }
    _op_class = jetOp
...
class kdblurComponent(SpectralComponent):
    _comp_name = "kdblur"
    _config = {
        "Index": (3.0, -10.0, 10.0, True, False),
        "Rin_G": (4.5, 1.235, 400.0, True, False),
        "Rout_G": (100.0, 1.235, 400.0, True, False),
        "Incl": (30.0, 0.0, 90.0, False, False),
    }
    _op_class = kdblurOp
...
class kdblur(SpectralModel):
    def __init__(
        ...
        super().__init__(
            [
                kdblurComponent(
                    Index, Rin_G, Rout_G, Incl, name, grad_method, eps
                )
            ]
        )
...
class kdblur2Component(SpectralComponent):
    ...
    _config = {
        ...
        "Rout_G": (100.0, 1.235, 400.0, True, False),
        "Incl": (30.0, 0.0, 90.0, False, False),
        "Rbreak": (20.0, 1.235, 400.0, True, False),
        "Index1": (3.0, -10.0, 10.0, True, False),
    }
    _op_class = kdblur2Op
...
class kerrbbComponent(SpectralComponent):
    _comp_name = "kerrbb"
    _config = {
        "eta": (0.0, 0.0, 1.0, True, False),
        "a": (0.0, -1.0, 0.9999, False, False),
        "i": (30.0, 0.0, 85.0, True, False),
        "Mbh": (1.0, 0.0, 100.0, False, False),
        "Mdd": (1.0, 0.0, 1000.0, False, False),
        "Dbh": (10.0, 0.0, 10000.0, True, False),
        "hd": (1.7, 1.0, 10.0, True, False),
        "rflag": (1, None, None, True, False),
        "lflag": (0, None, None, True, False),
        "norm": (1, 1e-10, 10000000000.0, False, False),
    }
    _op_class = kerrbbOp
...
class kerrconvComponent(SpectralComponent):
    ...
    _config = {
        "Index1": (3.0, -10.0, 10.0, True, False),
        "Index2": (3.0, -10.0, 10.0, True, False),
        "r_br_g": (6.0, 1.0, 400.0, True, False),
        "a": (0.998, 0.0, 0.998, False, False),
        "Incl": (30.0, 0.0, 90.0, True, False),
        "Rin_ms": (1.0, 1.0, 400.0, True, False),
        "Rout_ms": (400.0, 1.0, 400.0, True, False),
    }
...
class kerrdComponent(SpectralComponent):
    _comp_name = "kerrd"
    _config = {
        "distance": (1.0, 0.01, 1000.0, True, False),
        "TcoloTeff": (1.5, 1.0, 2.0, True, False),
        "M": (1.0, 0.1, 100.0, False, False),
        "Mdot": (1.0, 0.01, 100.0, False, False),
        "Incl": (30.0, 0.0, 90.0, True, False),
        "Rin": (1.235, 1.235, 100.0, True, False),
        "Rout": (100000.0, 10000.0, 100000000.0, True, False),
        "norm": (1, 1e-10, 10000000000.0, False, False),
    }
    _op_class = kerrdOp
...
class kerrdiskComponent(SpectralComponent):
    _comp_name = "kerrdisk"
    _config = {
        "lineE": (6.4, 0.1, 100.0, True, False),
        "Index1": (3.0, -10.0, 10.0, True, False),
        "Index2": (3.0, -10.0, 10.0, True, False),
        "r_br_g": (6.0, 1.0, 400.0, True, False),
        "a": (0.998, 0.01, 0.998, False, False),
        "Incl": (30.0, 0.0, 90.0, True, False),
        "Rin_ms": (1.0, 1.0, 400.0, True, False),
        "Rout_ms": (400.0, 1.0, 400.0, True, False),
        "z": (0.0, 0.0, 10.0, True, False),
...
class kyconvComponent(SpectralComponent):
    _comp_name = "kyconv"
    _config = {
        "a": (0.9982, 0.0, 1.0, False, False),
        "theta_o": (30.0, 0.0, 89.0, False, False),
        "rin": (1.0, 1.0, 1000.0, True, False),
        "ms": (1.0, 0.0, 1.0, True, False),
        "rout": (400.0, 1.0, 1000.0, True, False),
        "alpha": (3.0, -20.0, 20.0, True, False),
        "beta": (3.0, -20.0, 20.0, True, False),
        "rb": (400.0, 1.0, 1000.0, True, False),
        "zshift": (0.0, -0.999, 10.0, True, False),
        "limb": (0.0, 0.0, 2.0, True, False),
        "ne_loc": (100.0, 3.0, 5000.0, True, False),
        "normal": (1.0, -1.0, 100.0, True, False),
    }
    _op_class = kyconvOp
...
class kyrlineComponent(SpectralComponent):
    ...
    _config = {
        ...
        "ms": (1.0, 0.0, 1.0, True, False),
        "rout": (400.0, 1.0, 1000.0, True, False),
        "Erest": (6.4, 1.0, 99.0, True, False),
        "alpha": (3.0, -20.0, 20.0, True, False),
        "beta": (3.0, -20.0, 20.0, True, False),
        "rb": (400.0, 1.0, 1000.0, True, False),
        "zshift": (0.0, -0.999, 10.0, True, False),
        "limb": (1.0, 0.0, 2.0, True, False),
        "norm": (1, 1e-10, 10000000000.0, False, False),
    }
    _op_class = kyrlineOp
...
class laorComponent(SpectralComponent):
    _comp_name = "laor"
    _config = {
        "lineE": (6.4, 0.0, 100.0, False, False),
        "Index": (3.0, -10.0, 10.0, True, False),
        "Rin_G": (1.235, 1.235, 400.0, True, False),
        "Rout_G": (400.0, 1.235, 400.0, True, False),
        "Incl": (30.0, 0.0, 90.0, True, False),
        "norm": (1, 1e-10, 10000000000.0, False, False),
    }
    _op_class = laorOp
    ...
    def __init__(
        self, lineE, Index, Rin_G, Rout_G, Incl, norm, name, grad_method, eps
    ):
        kwargs = {
            k: v for k, v in locals().items() if k not in ("self", "__class__")
        }
...
class logparComponent(SpectralComponent):
    _comp_name = "logpar"
    _config = {
        "alpha": (1.5, 0.0, 4.0, False, False),
        "beta": (0.2, -4.0, 4.0, False, False),
        "pivotE": (1.0, None, None, True, False),
        "norm": (1, 1e-10, 10000000000.0, False, False),
    }
    _op_class = logparOp
...
class logpar(SpectralModel):
    def __init__(
        ...
        super().__init__(
            [
                logparComponent(
                    alpha, beta, pivotE, norm, name, grad_method, eps
                )
            ]
        )
...
class lorentzComponent(SpectralComponent):
    ...
    _config = {
        "LineE": (6.5, 0.0, 1000000.0, False, False),
        "Width": (0.1, 0.0, 20.0, False, False),
        "norm": (1, 1e-10, 10000000000.0, False, False),
    }
    _op_class = lorentzOp
...
class lorentz(SpectralModel):
    def __init__(
        ...
        super().__init__(
            [lorentzComponent(LineE, Width, norm, name, grad_method, eps)]
        )
...
class lsmooth(SpectralModel):
    def __init__(
        ...
        super().__init__(
            [lsmoothComponent(Sig_6keV, Index, name, grad_method, eps)]
        )
...
class lymanComponent(SpectralComponent):
    _comp_name = "lyman"
    _config = {
        "n": (1e-05, 0.0, 1000000.0, False, False),
        "b": (10.0, 1.0, 1000000.0, False, False),
        "z": (0.0, -0.001, 100000.0, False, False),
        "ZA": (1.0, 1.0, 2.0, False, False),
    }
    _op_class = lymanOp
...
class mekaComponent(SpectralComponent):
    _comp_name = "meka"
    _config = {
        "kT": (1.0, 0.001, 100.0, False, False),
        "nH": (1.0, 1e-06, 1e20, True, False),
        "Abundanc": (1.0, 0.0, 1000.0, True, False),
        "Redshift": (0.0, -0.999, 10.0, True, False),
        "norm": (1, 1e-10, 10000000000.0, False, False),
    }
    _op_class = mekaOp
    ...
    def __init__(
        self, kT, nH, Abundanc, Redshift, norm, name, grad_method, eps
    ):
        kwargs = {
            k: v for k, v in locals().items() if k not in ("self", "__class__")
        }
...
class meka(SpectralModel):
    def __init__(
        ...
        super().__init__(
            [
                mekaComponent(
                    kT, nH, Abundanc, Redshift, norm, name, grad_method, eps
                )
            ]
        )
...
class mekalComponent(SpectralComponent):
    ...
    def __init__(
        self, kT, nH, Abundanc, Redshift, switch, norm, name, grad_method, eps
    ):
        kwargs = {
            k: v for k, v in locals().items() if k not in ("self", "__class__")
        }
...
class neiComponent(SpectralComponent):
    ...
    def __init__(
        self, kT, Abundanc, Tau, Redshift, norm, name, grad_method, eps
    ):
        kwargs = {
            k: v for k, v in locals().items() if k not in ("self", "__class__")
        }
...
class nei(SpectralModel):
    def __init__(
        ...
        super().__init__(
            [
                neiComponent(
                    kT, Abundanc, Tau, Redshift, norm, name, grad_method, eps
                )
            ]
        )
...
class notchComponent(SpectralComponent):
    _comp_name = "notch"
    _config = {
        "LineE": (3.5, 0.0, 20.0, False, False),
        "Width": (1.0, 0.0, 20.0, False, False),
        "CvrFract": (1.0, 0.0, 1.0, True, False),
    }
    _op_class = notchOp
...
class notch(SpectralModel):
    def __init__(
        ...
        super().__init__(
            [notchComponent(LineE, Width, CvrFract, name, grad_method, eps)]
        )
...
class npshockComponent(SpectralComponent):
    _comp_name = "npshock"
    _config = {
        "kT_a": (1.0, 0.0808, 79.9, False, False),
        "kT_b": (0.5, 0.01, 79.9, False, False),
        "Abundanc": (1.0, 0.0, 10000.0, True, False),
        "Tau_l": (0.0, 0.0, 50000000000000.0, True, False),
        "Tau_u": (100000000000.0, 100000000.0, 50000000000000.0, False, False),
        "Redshift": (0.0, -0.999, 10.0, True, False),
        "norm": (1, 1e-10, 10000000000.0, False, False),
    }
    _op_class = npshockOp
...
class nsaComponent(SpectralComponent):
    _comp_name = "nsa"
    _config = {
        "LogT_eff": (6.0, 5.0, 7.0, False, False),
        "M_ns": (1.4, 0.5, 2.5, False, False),
        "R_ns": (10.0, 5.0, 20.0, False, False),
        "MagField": (0.0, 0.0, 50000000000000.0, True, False),
        "norm": (1, 1e-10, 10000000000.0, False, False),
    }
    _op_class = nsaOp

    def __init__(
        self, LogT_eff, M_ns, R_ns, MagField, norm, name, grad_method, eps
    ):
        kwargs = {
            k: v for k, v in locals().items() if k not in ("self", "__class__")
        }
...
class nsagravComponent(SpectralComponent):
    _comp_name = "nsagrav"
    _config = {
        "LogT_eff": (6.0, 5.5, 6.5, False, False),
        "NSmass": (1.4, 0.3, 2.5, False, False),
        "NSrad": (10.0, 6.0, 20.0, False, False),
        "norm": (1, 1e-10, 10000000000.0, False, False),
    }
    _op_class = nsagravOp
...
class nsagrav(SpectralModel):
    def __init__(
        ...
        super().__init__(
            [
                nsagravComponent(
                    LogT_eff, NSmass, NSrad, norm, name, grad_method, eps
                )
            ]
        )
...
class nsatmosComponent(SpectralComponent):
    _comp_name = "nsatmos"
    _config = {
        "LogT_eff": (6.0, 5.0, 6.5, False, False),
        "M_ns": (1.4, 0.5, 3.0, False, False),
        "R_ns": (10.0, 5.0, 30.0, False, False),
        "dist": (10.0, 0.1, 100.0, False, False),
        "norm": (1, 1e-10, 10000000000.0, False, False),
    }
    _op_class = nsatmosOp

    def __init__(
        self, LogT_eff, M_ns, R_ns, dist, norm, name, grad_method, eps
    ):
        kwargs = {
            k: v for k, v in locals().items() if k not in ("self", "__class__")
        }
...
class nsatmos(SpectralModel):
    def __init__(
        ...
        super().__init__(
            [
                nsatmosComponent(
                    LogT_eff, M_ns, R_ns, dist, norm, name, grad_method, eps
                )
            ]
        )
...
class nsmaxComponent(SpectralComponent):
    _comp_name = "nsmax"
    _config = {
        "logTeff": (6.0, 5.5, 6.8, False, False),
        "redshift": (0.1, 1e-05, 2.0, False, False),
        "specfile": (1200, None, None, True, False),
        "norm": (1, 1e-10, 10000000000.0, False, False),
    }
    _op_class = nsmaxOp

    def __init__(
        self, logTeff, redshift, specfile, norm, name, grad_method, eps
    ):
        kwargs = {
            k: v for k, v in locals().items() if k not in ("self", "__class__")
        }
...
class nsmax(SpectralModel):
    def __init__(
        ...
        super().__init__(
            [
                nsmaxComponent(
                    logTeff, redshift, specfile, norm, name, grad_method, eps
                )
            ]
        )
...
class nsmaxgComponent(SpectralComponent):
    _comp_name = "nsmaxg"
    _config = {
        "logTeff": (6.0, 5.5, 6.9, False, False),
        "M_ns": (1.4, 0.5, 3.0, False, False),
        "R_ns": (10.0, 5.0, 30.0, False, False),
        "dist": (1.0, 0.01, 100.0, False, False),
        "specfile": (1200, None, None, True, False),
        "norm": (1, 1e-10, 10000000000.0, False, False),
    }
    _op_class = nsmaxgOp
    ...
    def __init__(
        self, logTeff, M_ns, R_ns, dist, specfile, norm, name, grad_method, eps
    ):
        kwargs = {
            k: v for k, v in locals().items() if k not in ("self", "__class__")
        }
...
class nsxComponent(SpectralComponent):
    _comp_name = "nsx"
    _config = {
        "logTeff": (6.0, 5.5, 6.7, False, False),
        "M_ns": (1.4, 0.5, 3.0, False, False),
        "R_ns": (10.0, 5.0, 30.0, False, False),
        "dist": (1.0, 0.01, 100.0, False, False),
        "specfile": (6, None, None, True, False),
        "norm": (1, 1e-10, 10000000000.0, False, False),
    }
    _op_class = nsxOp
...
class nteeaComponent(SpectralComponent):
    _comp_name = "nteea"
    _config = {
        "l_nth": (100.0, 0.0, 10000.0, False, False),
        "l_bb": (100.0, 0.0, 10000.0, False, False),
        "f_refl": (0.0, 0.0, 4.0, False, False),
        "kT_bb": (10.0, 1.0, 100.0, True, False),
        "g_max": (1000.0, 5.0, 10000.0, True, False),
        "l_th": (0.0, 0.0, 10000.0, True, False),
        "tau_p": (0.0, 0.0, 10.0, True, False),
        "G_inj": (0.0, 0.0, 5.0, True, False),
        "g_min": (1.3, 1.0, 1000.0, True, False),
        "g_0": (1.3, 1.0, 5.0, True, False),
        "radius": (10000000000000.0, 100000.0, 1e16, True, False),
        "pair_esc": (0.0, 0.0, 1.0, True, False),
        "cosIncl": (0.45, 0.05, 0.95, False, False),
        "Fe_abund": (1.0, 0.1, 10.0, True, False),
        "Redshift": (0.0, -0.999, 10.0, True, False),
        "norm": (1, 1e-10, 10000000000.0, False, False),
    }
...
class nthCompComponent(SpectralComponent):
    ...
    _config = {
        "Gamma": (1.7, 1.001, 10.0, False, False),
        "kT_e": (100.0, 1.0, 1000.0, False, False),
        "kT_bb": (0.1, 0.001, 10.0, True, False),
        "inp_type": (0.0, 0.0, 1.0, True, False),
        "Redshift": (0.0, -0.999, 10.0, True, False),
        "norm": (1, 1e-10, 10000000000.0, False, False),
    }
    _op_class = nthCompOp
...
class olivineabsComponent(SpectralComponent):
    ...
    _config = {
        "moliv": (1.0, 0.0, 100000.0, False, False),
        "redshift": (0.0, -1.0, 10.0, True, False),
    }
...
class olivineabs(SpectralModel):
    def __init__(
        self, moliv=None, redshift=None, name=None, grad_method="f", eps=1e-7
    ):
        super().__init__(
            [olivineabsComponent(moliv, redshift, name, grad_method, eps)]
        )
...
class optxagnComponent(SpectralComponent):
    _comp_name = "optxagn"
    _config = {
        "mass": (10000000.0, 1.0, 1000000000.0, True, False),
        "dist": (100.0, 0.01, 1000000000.0, True, False),
        "logLoLEdd": (-1.0, -10.0, 2.0, False, False),
        "astar": (0.0, 0.0, 0.998, True, False),
        "rcor": (10.0, 1.0, 100.0, False, False),
        "logrout": (5.0, 3.0, 7.0, True, False),
        "kT_e": (0.2, 0.01, 10.0, False, False),
        "tau": (10.0, 0.1, 100.0, False, False),
        "Gamma": (2.1, 0.5, 10.0, False, False),
        "fpl": (0.0001, 0.0, 0.1, False, False),
        "fcol": (2.4, 1.0, 5.0, True, False),
        "tscat": (100000.0, 10000.0, 100000.0, True, False),
        "Redshift": (0.0, 0.0, 10.0, True, False),
        "norm": (1, 1e-10, 10000000000.0, False, False),
    }
    _op_class = optxagnOp
...
class optxagnfComponent(SpectralComponent):
    ...
    _config = {
        ...
        "kT_e": (0.2, 0.01, 10.0, False, False),
        "tau": (10.0, 0.1, 100.0, False, False),
        "Gamma": (2.1, 1.05, 10.0, False, False),
        "fpl": (0.0001, 0.0, 1.0, False, False),
        "Redshift": (0.0, 0.0, 10.0, True, False),
        "norm": (1, 1e-10, 10000000000.0, False, False),
    }
...
class pcfabsComponent(SpectralComponent):
    ...
    _config = {
        "nH": (1.0, 0.0, 1000000.0, False, False),
        "CvrFract": (0.5, 0.0, 1.0, False, False),
    }
    _op_class = pcfabsOp
...
class pcfabs(SpectralModel):
    def __init__(
        self, nH=None, CvrFract=None, name=None, grad_method="f", eps=1e-7
    ):
        super().__init__(
            [pcfabsComponent(nH, CvrFract, name, grad_method, eps)]
        )
...
class pegpwrlwComponent(SpectralComponent):
    ...
    _config = {
        "PhoIndex": (1.0, -3.0, 10.0, False, False),
        "eMin": (2.0, -100.0, 10000000000.0, True, False),
        "eMax": (10.0, -100.0, 10000000000.0, True, False),
        "norm": (1, 1e-10, 10000000000.0, False, False),
    }
...
class pegpwrlw(SpectralModel):
    def __init__(
        ...
        super().__init__(
            [
                pegpwrlwComponent(
                    PhoIndex, eMin, eMax, norm, name, grad_method, eps
                )
            ]
        )
...
class pexmonComponent(SpectralComponent):
    _comp_name = "pexmon"
    _config = {
        "PhoIndex": (2.0, 1.1, 2.5, False, False),
        "foldE": (1000.0, 1.0, 1000000.0, True, False),
        "rel_refl": (-1.0, -1000000.0, 1000000.0, True, False),
        "redshift": (0.0, 0.0, 4.0, True, False),
        "abund": (1.0, 0.0, 1000000.0, True, False),
        "Fe_abund": (1.0, 0.0, 100.0, True, False),
        "Incl": (60.0, 0.0, 85.0, False, False),
        "norm": (1, 1e-10, 10000000000.0, False, False),
    }
    _op_class = pexmonOp
...
class pexravComponent(SpectralComponent):
    _comp_name = "pexrav"
    _config = {
        "PhoIndex": (2.0, -10.0, 10.0, False, False),
        "foldE": (100.0, 1.0, 1000000.0, False, False),
        "rel_refl": (0.0, 0.0, 1000000.0, False, False),
        "Redshift": (0.0, -0.999, 10.0, True, False),
        "abund": (1.0, 0.0, 1000000.0, True, False),
...
class plabsComponent(SpectralComponent):
    _comp_name = "plabs"
    _config = {
        "index": (2.0, 0.0, 5.0, False, False),
        "coef": (1.0, 0.0, 100.0, False, False),
    }
    _op_class = plabsOp
...
class plabs(SpectralModel):
    def __init__(
        self, index=None, coef=None, name=None, grad_method="f", eps=1e-7
    ):
...
class plcabsComponent(SpectralComponent):
    ...
    _config = {
        "nH": (1.0, 0.0, 1000000.0, False, False),
        "nmax": (1.0, None, None, True, False),
        "FeAbun": (1.0, 0.0, 10.0, True, False),
        "FeKedge": (7.11, 7.0, 10.0, True, False),
        "PhoIndex": (2.0, -3.0, 10.0, False, False),
        "HighECut": (95.0, 0.01, 200.0, True, False),
        "foldE": (100.0, 1.0, 1000000.0, True, False),
        "acrit": (1.0, 0.0, 1.0, True, False),
        "FAST": (0.0, None, None, True, False),
        "Redshift": (0.0, -0.999, 10.0, True, False),
        "norm": (1, 1e-10, 10000000000.0, False, False),
    }
    _op_class = plcabsOp
...
class polconstComponent(SpectralComponent):
    _comp_name = "polconst"
    _config = {
        "A": (1.0, 0.0, 1.0, False, False),
        "psi": (45.0, -90.0, 90.0, False, False),
    }
...
class pollinComponent(SpectralComponent):
    _comp_name = "pollin"
    _config = {
        "A1": (1.0, 0.0, 1.0, False, False),
        "Aslope": (0.0, -5.0, 5.0, False, False),
        "psi1": (45.0, -90.0, 90.0, False, False),
        "psislope": (0.0, -5.0, 5.0, False, False),
    }
    _op_class = pollinOp
...
class pollin(SpectralModel):
    def __init__(
        ...
        super().__init__(
            [
                pollinComponent(
                    A1, Aslope, psi1, psislope, name, grad_method, eps
                )
            ]
        )
...
class polpowComponent(SpectralComponent):
    _comp_name = "polpow"
    _config = {
        "Anorm": (1.0, 0.0, 1.0, False, False),
        "Aindex": (0.0, -5.0, 5.0, False, False),
        "psinorm": (45.0, -90.0, 90.0, False, False),
        "psiindex": (0.0, -5.0, 5.0, False, False),
    }
    _op_class = polpowOp

    def __init__(
        self, Anorm, Aindex, psinorm, psiindex, name, grad_method, eps
    ):
        kwargs = {
            k: v for k, v in locals().items() if k not in ("self", "__class__")
        }
...
class polpow(SpectralModel):
    def __init__(
        ...
        super().__init__(
            [
                polpowComponent(
                    Anorm, Aindex, psinorm, psiindex, name, grad_method, eps
                )
            ]
        )
...
class powerlaw(SpectralModel):
    def __init__(
        self, PhoIndex=None, norm=None, name=None, grad_method="f", eps=1e-7
    ):
        super().__init__(
            [powerlawComponent(PhoIndex, norm, name, grad_method, eps)]
        )
...
class pwabComponent(SpectralComponent):
    _comp_name = "pwab"
    _config = {
        "nHmin": (1.0, 1e-07, 1000000.0, False, False),
        "nHmax": (2.0, 1e-07, 1000000.0, False, False),
        "beta": (1.0, -10.0, 20.0, True, False),
    }
    _op_class = pwabOp
...
class pwab(SpectralModel):
    def __init__(
        ...
        super().__init__(
            [pwabComponent(nHmin, nHmax, beta, name, grad_method, eps)]
        )
...
class qsosedComponent(SpectralComponent):
    _comp_name = "qsosed"
    _config = {
        "mass": (10000000.0, 100000.0, 10000000000.0, True, False),
        "dist": (100.0, 0.01, 1000000000.0, True, False),
        "logmdot": (-1.0, -1.65, 0.39, False, False),
        "astar": (0.0, -1.0, 0.998, True, False),
        "cosi": (0.5, 0.05, 1.0, True, False),
        "redshift": (0.0, 0.0, 5.0, True, False),
        "norm": (1, 1e-10, 10000000000.0, False, False),
...
class rdblur(SpectralModel):
    def __init__(
        ...
        super().__init__(
            [
                rdblurComponent(
                    Betor10, Rin_M, Rout_M, Incl, name, grad_method, eps
                )
            ]
        )
...
class redgeComponent(SpectralComponent):
    _comp_name = "redge"
    _config = {
        "edge": (1.4, 0.001, 100.0, False, False),
        "kT": (1.0, 0.001, 100.0, False, False),
        "norm": (1, 1e-10, 10000000000.0, False, False),
    }
    _op_class = redgeOp
...
class redge(SpectralModel):
    def __init__(
        ...
        super().__init__(
            [redgeComponent(edge, kT, norm, name, grad_method, eps)]
        )
...
class refschComponent(SpectralComponent):
    ...
    _config = {
        "PhoIndex": (2.0, -10.0, 10.0, False, False),
        "foldE": (100.0, 1.0, 1000000.0, False, False),
        "rel_refl": (0.0, 0.0, 2.0, False, False),
        "Redshift": (0.0, -0.999, 10.0, True, False),
        "abund": (1.0, 0.5, 10.0, True, False),
        "Fe_abund": (1.0, 0.1, 10.0, True, False),
        "Incl": (30.0, 19.0, 87.0, True, False),
        "T_disk": (30000.0, 10000.0, 1000000.0, True, False),
        "xi": (1.0, 0.0, 5000.0, False, False),
        "Betor10": (-2.0, -10.0, 20.0, True, False),
        "Rin": (10.0, 6.0, 10000.0, True, False),
        "Rout": (1000.0, 0.0, 10000000.0, True, False),
        "accuracy": (30.0, 30.0, 100000.0, True, False),
        "norm": (1, 1e-10, 10000000000.0, False, False),
    }
    _op_class = refschOp
...
class rfxconvComponent(SpectralComponent):
    _comp_name = "rfxconv"
    _config = {
        "rel_refl": (-1.0, -1.0, 1000000.0, False, False),
        "redshift": (0.0, 0.0, 4.0, True, False),
        "Fe_abund": (1.0, 0.5, 3.0, True, False),
        "cosIncl": (0.5, 0.05, 0.95, True, False),
        "log_xi": (1.0, 1.0, 6.0, False, False),
    }
    _op_class = rfxconvOp
...
class sedovComponent(SpectralComponent):
    ...
    def __init__(
        self, kT_a, kT_b, Abundanc, Tau, Redshift, norm, name, grad_method, eps
    ):
        kwargs = {
            k: v for k, v in locals().items() if k not in ("self", "__class__")
        }
...
class simplComponent(SpectralComponent):
    _comp_name = "simpl"
    _config = {
        "Gamma": (2.3, 1.0, 5.0, False, False),
        "FracSctr": (0.05, 0.0, 1.0, False, False),
        "UpScOnly": (1.0, 0.0, 100.0, True, False),
    }
    _op_class = simplOp
...
class simpl(SpectralModel):
    def __init__(
        ...
        super().__init__(
            [simplComponent(Gamma, FracSctr, UpScOnly, name, grad_method, eps)]
        )
...
class sirfComponent(SpectralComponent):
    _comp_name = "sirf"
    _config = {
        "tin": (1.0, 0.01, 1000.0, False, False),
        "rin": (0.01, 1e-06, 10.0, False, False),
        "rout": (100.0, 0.1, 100000000.0, False, False),
        "theta": (22.9, 0.0, 90.0, False, False),
        "incl": (0.0, -90.0, 90.0, True, False),
        "valpha": (-0.5, -1.5, 5.0, True, False),
        "gamma": (1.333, 0.5, 10.0, True, False),
        "mdot": (1000.0, 0.5, 10000000.0, True, False),
        "irrad": (2.0, 0.0, 20.0, True, False),
        "norm": (1, 1e-10, 10000000000.0, False, False),
    }
    _op_class = sirfOp
...
class slimbhComponent(SpectralComponent):
    _comp_name = "slimbh"
    _config = {
        "M": (10.0, 0.0, 1000.0, True, False),
        "a": (0.0, 0.0, 0.999, False, False),
        "lumin": (0.5, 0.05, 1.0, False, False),
        "alpha": (0.1, 0.005, 0.1, True, False),
        "inc": (60.0, 0.0, 85.0, True, False),
        "D": (10.0, 0.0, 10000.0, True, False),
        "f_hard": (-1.0, -10.0, 10.0, True, False),
        "lflag": (1, None, None, True, False),
        "vflag": (1, None, None, True, False),
        "norm": (1, 1e-10, 10000000000.0, False, False),
    }
    _op_class = slimbhOp
...
class smaugComponent(SpectralComponent):
    _comp_name = "smaug"
    _config = {
        "kT_cc": (1.0, 0.08, 100.0, False, False),
        "kT_dt": (1.0, 0.0, 100.0, False, False),
        "kT_ix": (0.0, 0.0, 10.0, True, False),
        "kT_ir": (0.1, 0.0001, 1.0, True, False),
        "kT_cx": (0.5, 0.0, 10.0, False, False),
        "kT_cr": (0.1, 0.0001, 20.0, False, False),
        "kT_tx": (0.0, 0.0, 10.0, True, False),
        "kT_tr": (0.5, 0.0001, 3.0, True, False),
        "nH_cc": (1.0, 1e-06, 3.0, True, False),
        "nH_ff": (1.0, 0.0, 1.0, True, False),
        "nH_cx": (0.5, 0.0, 10.0, False, False),
        "nH_cr": (0.1, 0.0001, 2.0, False, False),
        "nH_gx": (0.0, 0.0, 10.0, True, False),
        "nH_gr": (0.002, 0.0001, 20.0, True, False),
        "Ab_cc": (1.0, 0.0, 5.0, True, False),
        "Ab_xx": (0.0, 0.0, 10.0, True, False),
        "Ab_rr": (0.1, 0.0001, 1.0, True, False),
        "redshift": (0.01, 0.0001, 10.0, True, False),
        "meshpts": (10.0, 1.0, 10000.0, True, False),
        "rcutoff": (2.0, 1.0, 3.0, True, False),
        "mode": (1.0, 0.0, 2.0, True, False),
        "itype": (2.0, 1.0, 4.0, True, False),
        "norm": (1, 1e-10, 10000000000.0, False, False),
    }
    _op_class = smaugOp
...
class smedgeComponent(SpectralComponent):
    _comp_name = "smedge"
    _config = {
        "edgeE": (7.0, 0.1, 100.0, False, False),
        "MaxTau": (1.0, 0.0, 10.0, False, False),
        "index": (-2.67, -10.0, 10.0, True, False),
        "width": (10.0, 0.01, 100.0, False, False),
    }
    _op_class = smedgeOp
...
class smedge(SpectralModel):
    def __init__(
        ...
        super().__init__(
            [
                smedgeComponent(
                    edgeE, MaxTau, index, width, name, grad_method, eps
                )
            ]
        )
...
class snapecComponent(SpectralComponent):
    ...
    _config = {
        "kT": (1.0, 0.008, 64.0, False, False),
        "N_SNe": (1.0, 0.0, 1e20, False, False),
        "R": (1.0, 0.0, 1e20, False, False),
        "SNIModelIndex": (1.0, 0.0, 125.0, True, False),
        "SNIIModelIndex": (1.0, 0.0, 125.0, True, False),
        "redshift": (0.0, 0.0, 10.0, True, False),
        "norm": (1, 1e-10, 10000000000.0, False, False),
    }
    _op_class = snapecOp
...
class spexpcutComponent(SpectralComponent):
    _comp_name = "spexpcut"
    _config = {
        "Ecut": (10.0, 0.0, 1000000.0, False, False),
        "alpha": (1.0, -5.0, 5.0, False, False),
    }
...
class spexpcut(SpectralModel):
    def __init__(
        self, Ecut=None, alpha=None, name=None, grad_method="f", eps=1e-7
    ):
        super().__init__(
            [spexpcutComponent(Ecut, alpha, name, grad_method, eps)]
        )
...
class splineComponent(SpectralComponent):
    _comp_name = "spline"
    _config = {
        "Estart": (0.1, 0.0, 100.0, False, False),
        "Ystart": (1.0, -1000000.0, 1000000.0, False, False),
        "Yend": (1.0, -1000000.0, 1000000.0, False, False),
        "YPstart": (0.0, -1000000.0, 1000000.0, False, False),
        "YPend": (0.0, -1000000.0, 1000000.0, False, False),
        "Eend": (15.0, 0.0, 100.0, False, False),
    }
    _op_class = splineOp
...
class srcutComponent(SpectralComponent):
    _comp_name = "srcut"
    _config = {
        "alpha": (0.5, 1e-05, 1.0, False, False),
        "break_": (2.42e17, 10000000000.0, 1e25, False, False),
        "norm": (1, 1e-10, 10000000000.0, False, False),
    }
    _op_class = srcutOp
...
class srcut(SpectralModel):
    def __init__(
        ...
        super().__init__(
            [srcutComponent(alpha, break_, norm, name, grad_method, eps)]
        )
...
class srescComponent(SpectralComponent):
    ...
    _config = {
        "alpha": (0.5, 1e-05, 1.0, False, False),
        "rolloff": (2.42e17, 10000000000.0, 1e25, False, False),
        "norm": (1, 1e-10, 10000000000.0, False, False),
    }
    _op_class = srescOp
...
class sresc(SpectralModel):
    def __init__(
        ...
        super().__init__(
            [srescComponent(alpha, rolloff, norm, name, grad_method, eps)]
        )
...
class ssaComponent(SpectralComponent):
    _comp_name = "ssa"
    _config = {
        "te": (0.1, 0.01, 0.5, False, False),
        "y": (0.7, 0.0001, 1000.0, False, False),
        "norm": (1, 1e-10, 10000000000.0, False, False),
    }
    _op_class = ssaOp
...
class ssa(SpectralModel):
    def __init__(
        self, te=None, y=None, norm=None, name=None, grad_method="f", eps=1e-7
    ):
...
class stepComponent(SpectralComponent):
    _comp_name = "step"
    _config = {
        "Energy": (6.5, 0.0, 100.0, False, False),
        "Sigma": (0.1, 0.0, 20.0, False, False),
        "norm": (1, 1e-10, 10000000000.0, False, False),
    }
    _op_class = stepOp
...
class step(SpectralModel):
    def __init__(
        ...
        super().__init__(
            [stepComponent(Energy, Sigma, norm, name, grad_method, eps)]
        )
...
class swind1Component(SpectralComponent):
    _comp_name = "swind1"
    _config = {
        "column": (6.0, 3.0, 50.0, False, False),
        "log_xi": (2.5, 2.1, 4.1, False, False),
        "sigma": (0.1, 0.0, 0.5, False, False),
        "Redshift": (0.0, -0.999, 10.0, True, False),
    }
    _op_class = swind1Op

    def __init__(
        self, column, log_xi, sigma, Redshift, name, grad_method, eps
    ):
        kwargs = {
            k: v for k, v in locals().items() if k not in ("self", "__class__")
        }
...
class swind1(SpectralModel):
    def __init__(
        ...
        super().__init__(
            [
                swind1Component(
                    column, log_xi, sigma, Redshift, name, grad_method, eps
                )
            ]
        )
...
class tapecComponent(SpectralComponent):
    ...
    def __init__(
        self, kT, kTi, Abundanc, Redshift, norm, name, grad_method, eps
    ):
        kwargs = {
            k: v for k, v in locals().items() if k not in ("self", "__class__")
        }
...
class tapec(SpectralModel):
    def __init__(
        ...
        super().__init__(
            [
                tapecComponent(
                    kT, kTi, Abundanc, Redshift, norm, name, grad_method, eps
                )
            ]
        )
...
class thcompComponent(SpectralComponent):
    _comp_name = "thcomp"
    _config = {
        "Gamma_tau": (1.7, 1.001, 10.0, False, False),
        "kT_e": (50.0, 0.5, 150.0, False, False),
        "cov_frac": (1.0, 0.0, 1.0, False, False),
        "z": (0.0, 0.0, 5.0, True, False),
    }
    _op_class = thcompOp
...
class thcomp(SpectralModel):
    def __init__(
        ...
        super().__init__(
            [
                thcompComponent(
                    Gamma_tau, kT_e, cov_frac, z, name, grad_method, eps
                )
            ]
        )
...
class varabsComponent(SpectralComponent):
    _comp_name = "varabs"
    _config = {
        "H": (1.0, 0.0, 10000.0, True, False),
        "He": (1.0, 0.0, 10000.0, True, False),
        "C": (1.0, 0.0, 10000.0, True, False),
        "N": (1.0, 0.0, 10000.0, True, False),
        "O": (1.0, 0.0, 10000.0, True, False),
        "Ne": (1.0, 0.0, 10000.0, True, False),
        "Na": (1.0, 0.0, 10000.0, True, False),
        "Mg": (1.0, 0.0, 10000.0, True, False),
        "Al": (1.0, 0.0, 10000.0, True, False),
        "Si": (1.0, 0.0, 10000.0, True, False),
        "S": (1.0, 0.0, 10000.0, True, False),
        "Cl": (1.0, 0.0, 10000.0, True, False),
        "Ar": (1.0, 0.0, 10000.0, True, False),
        "Ca": (1.0, 0.0, 10000.0, True, False),
        "Cr": (1.0, 0.0, 10000.0, True, False),
        "Fe": (1.0, 0.0, 10000.0, True, False),
        "Co": (1.0, 0.0, 10000.0, True, False),
        "Ni": (1.0, 0.0, 10000.0, True, False),
    }
    _op_class = varabsOp
...
class vbremssComponent(SpectralComponent):
    ...
    _config = {
        "kT": (3.0, 0.0001, 200.0, False, False),
        "HeovrH": (1.0, 0.0, 100.0, False, False),
        "norm": (1, 1e-10, 10000000000.0, False, False),
    }
    _op_class = vbremssOp
...
class vbremss(SpectralModel):
    def __init__(
        ...
        super().__init__(
            [vbremssComponent(kT, HeovrH, norm, name, grad_method, eps)]
        )
...
class voigtComponent(SpectralComponent):
    ...
    _config = {
        "LineE": (6.5, 0.0, 1000000.0, False, False),
        "Sigma": (0.01, 0.0, 20.0, False, False),
        "Gamma": (0.01, 0.0, 20.0, False, False),
        "norm": (1, 1e-10, 10000000000.0, False, False),
    }
    _op_class = voigtOp
...
class voigt(SpectralModel):
    def __init__(
        ...
        super().__init__(
            [voigtComponent(LineE, Sigma, Gamma, norm, name, grad_method, eps)]
        )
...
class vraymondComponent(SpectralComponent):
    _comp_name = "vraymond"
    _config = {
        "kT": (6.5, 0.0808, 79.9, False, False),
        "He": (1.0, 0.0, 10000.0, True, False),
        "C": (1.0, 0.0, 10000.0, True, False),
        "N": (1.0, 0.0, 10000.0, True, False),
        "O": (1.0, 0.0, 10000.0, True, False),
...
class vvwdemComponent(SpectralComponent):
    _comp_name = "vvwdem"
    _config = {
        "Tmax": (1.0, 0.01, 20.0, False, False),
        "beta": (0.1, 0.01, 1.0, False, False),
        "inv_slope": (0.25, -1.0, 10.0, False, False),
        "nH": (1.0, 1e-06, 1e20, True, False),
        "H": (1.0, 0.0, 1000.0, True, False),
        "He": (1.0, 0.0, 1000.0, True, False),
        "Li": (1.0, 0.0, 1000.0, True, False),
...
class wndabsComponent(SpectralComponent):
    _comp_name = "wndabs"
    _config = {
        "nH": (1.0, 0.0, 20.0, False, False),
        "WindowE": (1.0, 0.03, 20.0, False, False),
    }
    _op_class = wndabsOp
...
class wndabs(SpectralModel):
    def __init__(
        self, nH=None, WindowE=None, name=None, grad_method="f", eps=1e-7
    ):
        super().__init__(
            [wndabsComponent(nH, WindowE, name, grad_method, eps)]
        )
...
class xilconvComponent(SpectralComponent):
    ...
    _config = {
        ...
        "cosIncl": (0.5, 0.05, 0.95, True, False),
        "log_xi": (1.0, 1.0, 6.0, False, False),
        "cutoff": (300.0, 20.0, 300.0, True, False),
    }
    _op_class = xilconvOp
...
class xionComponent(SpectralComponent):
    _comp_name = "xion"
    _config = {
        "height": (5.0, 0.0, 100.0, False, False),
        "lxovrld": (0.3, 0.02, 100.0, False, False),
        "rate": (0.05, 0.001, 1.0, False, False),
        "cosAng": (0.9, 0.0, 1.0, False, False),
        "inner": (3.0, 2.0, 1000.0, False, False),
        "outer": (100.0, 2.1, 100000.0, False, False),
        "index": (2.0, 1.6, 2.2, False, False),
        "Redshift": (0.0, -0.999, 10.0, True, False),
        "Feabun": (1.0, 0.0, 5.0, True, False),
        "E_cut": (150.0, 20.0, 300.0, False, False),
        "Ref_type": (1.0, 1.0, 3.0, True, False),
        "Rel_smear": (4.0, 1.0, 4.0, True, False),
        "Geometry": (1.0, 1.0, 4.0, True, False),
    }
    _op_class = xionOp
...
class xscatComponent(SpectralComponent):
    _comp_name = "xscat"
    _config = {
        "NH": (1.0, 0.0, 1000.0, False, False),
        "Xpos": (0.5, 0.0, 0.999, False, False),
        "Rext": (10.0, 0.0, 240.0, True, False),
        "DustModel": (1, None, None, True, False),
    }
    _op_class = xscatOp
...
class xscat(SpectralModel):
    def __init__(
        ...
        super().__init__(
            [xscatComponent(NH, Xpos, Rext, DustModel, name, grad_method, eps)]
        )
...
class zTBabs(SpectralModel):
    def __init__(
        ...
        super().__init__(
            [zTBabsComponent(nH, Redshift, name, grad_method, eps)]
        )
...
class zagauss(SpectralModel):
    def __init__(
        ...
        super().__init__(
            [
                zagaussComponent(
                    LineE, Sigma, Redshift, norm, name, grad_method, eps
                )
            ]
        )
...
class zbabsComponent(SpectralComponent):
    _comp_name = "zbabs"
    _config = {
        "nH": (0.0001, 0.0, 1000000.0, False, False),
        "nHeI": (1e-05, 0.0, 1000000.0, False, False),
        "nHeII": (1e-06, 0.0, 1000000.0, False, False),
        "z": (0.0, 0.0, 1000000.0, False, False),
    }
    _op_class = zbabsOp
...
class zbabs(SpectralModel):
    def __init__(
        ...
        super().__init__(
            [zbabsComponent(nH, nHeI, nHeII, z, name, grad_method, eps)]
        )
...
class zbbody(SpectralModel):
    def __init__(
        ...
        super().__init__(
            [zbbodyComponent(kT, Redshift, norm, name, grad_method, eps)]
        )
...
class zbremss(SpectralModel):
    def __init__(
        ...
        super().__init__(
            [zbremssComponent(kT, Redshift, norm, name, grad_method, eps)]
        )
...
class zcutoffplComponent(SpectralComponent):
    ...
    def __init__(
        self, PhoIndex, HighECut, Redshift, norm, name, grad_method, eps
    ):
        kwargs = {
            k: v for k, v in locals().items() if k not in ("self", "__class__")
        }
...
class zcutoffpl(SpectralModel):
    def __init__(
        ...
        super().__init__(
            [
                zcutoffplComponent(
                    PhoIndex, HighECut, Redshift, norm, name, grad_method, eps
                )
            ]
        )
...
class zdustComponent(SpectralComponent):
    _comp_name = "zdust"
    _config = {
        "method": (1, None, None, True, False),
        "E_BmV": (0.1, 0.0, 100.0, False, False),
        "Rv": (3.1, 0.0, 10.0, True, False),
        "Redshift": (0.0, 0.0, 20.0, True, False),
    }
    _op_class = zdustOp
...
class zdust(SpectralModel):
    def __init__(
        ...
        super().__init__(
            [
                zdustComponent(
                    method, E_BmV, Rv, Redshift, name, grad_method, eps
                )
            ]
        )
...
class zedge(SpectralModel):
    def __init__(
        ...
        super().__init__(
            [zedgeComponent(edgeE, MaxTau, Redshift, name, grad_method, eps)]
        )
...
class zhighectComponent(SpectralComponent):
    _comp_name = "zhighect"
    _config = {
        "cutoffE": (10.0, 0.0001, 200.0, False, False),
        "foldE": (15.0, 0.0001, 200.0, False, False),
        "Redshift": (0.0, -0.999, 10.0, True, False),
    }
...
class zhighect(SpectralModel):
    def __init__(
        ...
        super().__init__(
            [
                zhighectComponent(
                    cutoffE, foldE, Redshift, name, grad_method, eps
                )
            ]
        )
...
class zigmComponent(SpectralComponent):
    _comp_name = "zigm"
    _config = {
        "redshift": (0.0, None, None, True, False),
        "model": (0, None, None, True, False),
        "lyman_limit": (1, None, None, True, False),
    }
    _op_class = zigmOp
...
class zigm(SpectralModel):
    def __init__(
        ...
        super().__init__(
            [
                zigmComponent(
                    redshift, model, lyman_limit, name, grad_method, eps
                )
            ]
        )
...
class zkerrbbComponent(SpectralComponent):
    ...
    _config = {
        "eta": (0.0, 0.0, 1.0, True, False),
        "a": (0.5, -0.99, 0.9999, False, False),
        "i": (30.0, 0.0, 85.0, True, False),
        "Mbh": (10000000.0, 3.0, 10000000000.0, False, False),
        "Mdd": (1.0, 1e-05, 100000.0, False, False),
        "z": (0.01, 0.0, 10.0, True, False),
        "fcol": (2.0, -100.0, 100.0, True, False),
        "rflag": (1, None, None, True, False),
        "lflag": (1, None, None, True, False),
        "norm": (1, 1e-10, 10000000000.0, False, False),
    }
...
class zlogparComponent(SpectralComponent):
    ...
    def __init__(
        self, alpha, beta, pivotE, Redshift, norm, name, grad_method, eps
    ):
        kwargs = {
            k: v for k, v in locals().items() if k not in ("self", "__class__")
        }
...
class zlogpar(SpectralModel):
    def __init__(
        ...
        super().__init__(
            [
                zlogparComponent(
                    alpha, beta, pivotE, Redshift, norm, name, grad_method, eps
                )
            ]
        )
...
class zpcfabs(SpectralModel):
    def __init__(
        ...
        super().__init__(
            [zpcfabsComponent(nH, CvrFract, Redshift, name, grad_method, eps)]
        )
...
class zphabs(SpectralModel):
    def __init__(
        ...
        super().__init__(
            [zphabsComponent(nH, Redshift, name, grad_method, eps)]
        )
...
class zpowerlw(SpectralModel):
    def __init__(
        ...
        super().__init__(
            [
                zpowerlwComponent(
                    PhoIndex, Redshift, norm, name, grad_method, eps
                )
            ]
        )
...
class zreddenComponent(SpectralComponent):
    _comp_name = "zredden"
    _config = {
        "E_BmV": (0.05, 0.0, 10.0, False, False),
        "Redshift": (0.0, -0.999, 10.0, True, False),
    }
    _op_class = zreddenOp
...
class zredden(SpectralModel):
    def __init__(
        self, E_BmV=None, Redshift=None, name=None, grad_method="f", eps=1e-7
    ):
        super().__init__(
            [zreddenComponent(E_BmV, Redshift, name, grad_method, eps)]
        )
...
class zsmdustComponent(SpectralComponent):
    ...
    _config = {
        "E_BmV": (0.1, 0.0, 100.0, False, False),
        "ExtIndex": (1.0, -10.0, 10.0, False, False),
        "Rv": (3.1, 0.0, 10.0, True, False),
        "redshift": (0.0, 0.0, 20.0, True, False),
    }
    _op_class = zsmdustOp
...
class zsmdust(SpectralModel):
    def __init__(
        ...
        super().__init__(
            [
                zsmdustComponent(
                    E_BmV, ExtIndex, Rv, redshift, name, grad_method, eps
                )
            ]
        )
...
class zvfeabsComponent(SpectralComponent):
    ...
    _config = {
        "nH": (1.0, 0.0, 1000000.0, False, False),
        "metals": (1.0, 0.0, 100.0, False, False),
        "FEabun": (1.0, 0.0, 100.0, False, False),
        "FEKedge": (7.11, 7.0, 9.5, False, False),
        "Redshift": (0.0, -0.999, 10.0, True, False),
    }
    _op_class = zvfeabsOp

    def __init__(
        self, nH, metals, FEabun, FEKedge, Redshift, name, grad_method, eps
    ):
        kwargs = {
            k: v for k, v in locals().items() if k not in ("self", "__class__")
        }
...
class zwabs(SpectralModel):
    def __init__(
        ...
        super().__init__(
            [zwabsComponent(nH, Redshift, name, grad_method, eps)]
        )
...
class zwndabs(SpectralModel):
    def __init__(
        ...
        super().__init__(
            [zwndabsComponent(nH, WindowE, Redshift, name, grad_method, eps)]
        )
...
class zxipabComponent(SpectralComponent):
    _comp_name = "zxipab"
    _config = {
        "nHmin": (0.01, 1e-07, 1000000.0, False, False),
        "nHmax": (10.0, 1e-07, 1000000.0, False, False),
        "beta": (0.0, -10.0, 10.0, False, False),
        "log_xi": (3.0, -3.0, 6.0, False, False),
        "redshift": (0.0, 0.0, 10.0, True, False),
    }
    _op_class = zxipabOp

    def __init__(
        self, nHmin, nHmax, beta, log_xi, redshift, name, grad_method, eps
    ):
        kwargs = {
            k: v for k, v in locals().items() if k not in ("self", "__class__")
        }
...
class zxipcfComponent(SpectralComponent):
    _comp_name = "zxipcf"
    _config = {
        "Nh": (10.0, 0.05, 500.0, False, False),
        "log_xi": (3.0, -3.0, 6.0, False, False),
        "CvrFract": (0.5, 0.0, 1.0, False, False),
        "Redshift": (0.0, -0.999, 10.0, True, False),
    }
...
class zxipcf(SpectralModel):
    def __init__(
        ...
        super().__init__(
            [
                zxipcfComponent(
                    Nh, log_xi, CvrFract, Redshift, name, grad_method, eps
                )
            ]
        )
